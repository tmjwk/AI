...
const WEEKLY = [
  {
    ...
    "sections": [
      ...
      {
        "title_pl": "🎨 Nowe modele i narzędzia — 21 items z AI Search (9 nowych modeli, 228 total)",
        "title_en": "🎨 New models and tools — 21 items from AI Search (9 new models, 228 total)",
        "body_pl": "AI Search ##35-1 przyniósł 21 nowych items:\n\nLLM:\n- Ox Alpha revealed = GLM Flash! 320B MoE z vision capabilities (previous GLM nie miał). Open weights. Był mystery model na OpenRouter.\n- GLM 5.3 — most intelligent open-source model, tied z frontier. Unsloth GGUF 1-bit only 217GB.\n- Qwen 3.8 Flash Next — preview Qwen 4 architecture, tylko 6B active. Very efficient.\n- Hy4 — 10-cent model at frontier, 49B active MoE. Gated architecture + identity hyper connections. Unexpected.\n\nVideo:\n- FastH3 — Minimax 14x faster na B200 GPUs. DMD2 distillation. Closed API (controversial — open-source model made closed).\n- H3 Max — Minimax H3 sped up, paid closed API. Foul team says will open source.\n- Omni 1.1 Flash — video extension z 10s previous footage. 360p draft 60x faster + cheaper.\n- Wan 3.0 (Alibaba) — document-to-video, 30-sec single pass. Prices collapsing.\n\n3D / World Models:\n- Block 3D — rozbija 3D obiekt na bloki shape tokens, parallel generation. Code released.\n- One Video One World — input video → pełna animowana scena 3D. Łączy Qwen 3VL + SAM 3 + Flux 2.\n- Code World Model — video world model z underlying rules + consequences. Fine-tuned Minimax H3.\n- FixAnything — naprawia degraded 3D renders (gaussian splatting, nerf, mesh) używając pre-trained video model.\n- Orbit — 360° video dataset dla harder 3D reconstruction + robotics scenarios.\n\nImage:\n- Luma AI — creative agent + Luma Skills (reusable AI workflows). Define instructions once, save, run.\n- DiffusionOPSD — direct step-level rewards zamiast vague final reward. More precise training signal.\n- Fibo 1.5 — multi-attribute generation (description, location, size, shape, color, texture). Iterative editing.\n\nAudio:\n- Gemini 3.5 Transcribe — smart transcription: removes errors, filler words, auto-formats. Multi-speaker, multilingual, word-level timestamps.\n\nHardware:\n- Xiaomi AI Cube — 3 X-ring chips (O3, O100, D100). Runs 120B + 3B model lokalnie i jednocześnie. Beast device.\n\nRobotics:\n- S1 — robot uczy się task z jednego video, bez dodatkowego treningu. One-shot learning dla robots.\n- World Humanoid Games — Tien Gong robot 100m w 9.39s (beats Usain Bolt 9.58s!).\n\nOther:\n- Google PPE — Planetary Prediction Engine, AI data scientist dla Earth problems. Natural language → analysis.\n- VoiceMem — AI memory z left brain (facts) + right brain (preferences, personality, emotions).\n\n9 new models added to database (228 total).",
        "body_en": "AI Search ##35-1 brought 21 new items:\n\nLLM:\n- Ox Alpha revealed = GLM Flash! 320B MoE with vision capabilities (previous GLM didn't have). Open weights. Was mystery model on OpenRouter.\n- GLM 5.3 — most intelligent open-source model, tied with frontier. Unsloth GGUF 1-bit only 217GB.\n- Qwen 3.8 Flash Next — preview Qwen 4 architecture, only 6B active. Very efficient.\n- Hy4 — 10-cent model at frontier, 49B active MoE. Gated architecture + identity hyper connections. Unexpected.\n\nVideo:\n- FastH3 — Minimax 14x faster on B200 GPUs. DMD2 distillation. Closed API (controversial — open-source model made closed).\n- H3 Max — Minimax H3 sped up, paid closed API. Foul team says will open source.\n- Omni 1.1 Flash — video extension with 10s previous footage. 360p draft 60x faster + cheaper.\n- Wan 3.0 (Alibaba) — document-to-video, 30-sec single pass. Prices collapsing.\n\n3D / World Models:\n- Block 3D — breaks 3D object into blocks of shape tokens, parallel generation. Code released.\n- One Video One World — input video → full animated 3D scene. Combines Qwen 3VL + SAM 3 + Flux 2.\n- Code World Model — video world model with underlying rules + consequences. Fine-tuned Minimax H3.\n- FixAnything — fixes degraded 3D renders (gaussian splatting, nerf, mesh) using pre-trained video model.\n- Orbit — 360° video dataset for harder 3D reconstruction + robotics scenarios.\n\nImage:\n- Luma AI — creative agent + Luma Skills (reusable AI workflows). Define instructions once, save, run.\n- DiffusionOPSD — direct step-level rewards instead of vague final reward. More precise training signal.\n- Fibo 1.5 — multi-attribute generation (description, location, size, shape, color, texture). Iterative editing.\n\nAudio:\n- Gemini 3.5 Transcribe — smart transcription: removes errors, filler words, auto-formats. Multi-speaker, multilingual, word-level timestamps.\n\nHardware:\n- Xiaomi AI Cube — 3 X-ring chips (O3, O100, D100). Runs 120B + 3B model locally and simultaneously. Beast device.\n\nRobotics:\n- S1 — robot learns task from single video, no additional training. One-shot learning for robots.\n- World Humanoid Games — Tien Gong robot 100m in 9.39s (beats Usain Bolt 9.58s!).\n\nOther:\n- Google PPE — Planetary Prediction Engine, AI data scientist for Earth problems. Natural language → analysis.\n- VoiceMem — AI memory with left brain (facts) + right brain (preferences, personality, emotions).\n\n9 new models added to database (228 total).",
        "quotes": []
      },
      {
  ...
  },
  {
    ...
    "title_en": "AI Week #34 | August 17-23, 2026",
    "headline_pl": "Tydzień pauz i przełomów: OpenAI pauzuje frontier training, Elon's 100x prediction stała się faktem, DeepSeek V4 Flash Vision matches Opus 4.8, Avo harness → Claude Opus 5 100% ARC AGI 3, Unitree/Superman robot bije Usain Bolta (12.7 m/s), DeepSeek harness 180K GitHub stars (rekord), Moderna mRNA cancer vaccine działa, memory bottleneck (500% price jump), Anthropic $2T IPO, Stripe kupuje OpenRouter $7B.",
    "headline_en": "Week of pauses and breakthroughs: OpenAI pauses frontier training, Elon's 100x prediction became fact, DeepSeek V4 Flash Vision matches Opus 4.8, Avo harness → Claude Opus 5 100% ARC AGI 3, Unitree/Superman robot beats Usain Bolt (12.7 m/s), DeepSeek harness 180K GitHub stars (record), Moderna mRNA cancer vaccine works, memory bottleneck (500% price jump), Anthropic $2T IPO, Stripe buys OpenRouter $7B.",
    "sections": [
      {
        "title_pl": "🔴 OpenAI pauzuje frontier training — Astra nadal coming",
        "title_en": "🔴 OpenAI pauses frontier training — Astra still coming",
        "body_pl": "OpenAI ogłosił pauzę 'some Frontier RL training'. Astra (next-gen model) nadal coming. Anthropic rumored: używa next-gen internal models primarily for self-training i recursive self-improvement. Mythos 3 budowane wewnątrz Anthropic — nie zostanie wydane. Alex: 'Some Frontier RL training' — można split: modele idą do 'vocational school' (continued RL), ale frontier pre-training pause. Dave: Anthropic revenue per token maxing — codegen = $, ale stronger model może być więcej wart per token. To strategiczna pauza, nie kapitulacja.",
        "body_en": "OpenAI announced pause on 'some Frontier RL training'. Astra (next-gen model) still coming. Anthropic rumored: using next-gen internal models primarily for self-training and recursive self-improvement. Mythos 3 being built inside Anthropic — won't be released. Alex: 'Some Frontier RL training' — can split: models go to 'vocational school' (continued RL), but frontier pre-training pause. Dave: Anthropic revenue per token maxing — codegen = $, but stronger model may be worth more per token. This is strategic pause, not capitulation.",
        "quotes": []
      },
      {
        "title_pl": "🚀 Elon's 100x prediction stała się faktem + specialist AI",
        "title_en": "🚀 Elon's 100x prediction became fact + specialist AI",
        "body_pl": "Elon z 6 stycznia: '100x gains w AI w tym roku'. Teraz — fact. Tim Sweeney tweet, Elon responds: 'specialist AIs (single language, single area of knowledge) are another 100x on top of that'. Peter: 'last 8-10 years were 10x years, this is 100x a year'. Elon trenował Grok na danych SpaceX — engineering breakthroughs available. Alex: Elon's prediction = o sparsification (models przyszłości bardziej sparse). Emad: compaction is enemy of progress — harnesses both OpenAI i Anthropic mają compaction.",
        "body_en": "Elon from Jan 6: '100x gains in AI this year'. Now — fact. Tim Sweeney tweet, Elon responds: 'specialist AIs (single language, single area of knowledge) are another 100x on top of that'. Peter: 'last 8-10 years were 10x years, this is 100x a year'. Elon trained Grok on SpaceX data — engineering breakthroughs available. Alex: Elon's prediction = about sparsification (future models more sparse). Emad: compaction is enemy of progress — harnesses both OpenAI and Anthropic have compaction.",
        "quotes": []
      },
      {
        "title_pl": "💰 DeepSeek V4 Flash Vision — matches Opus 4.8 na agentic coding",
        "title_en": "💰 DeepSeek V4 Flash Vision — matches Opus 4.8 on agentic coding",
        "body_pl": "DeepSeek V4 Flash Vision — matches Opus 4.8 na agentic coding benchmarks. DeepSuite score improved by ~5. API only. Vision capabilities dodane do V4 Flash. DeepSeek kontynuuje dominance w cost-performance ratio. Cost per intelligence: Fable $3.14 (najdroższy) vs Luna Max $0.05 (najtańszy frontier). DeepSeek V4 Pro podniósł ceny z 5¢ do 25¢ — wciąż 10x tańszy niż amerykańskie frontier modele. Stripe kupuje OpenRouter za $7B (88% Forbes AI 50 na platformie).",
        "body_en": "DeepSeek V4 Flash Vision — matches Opus 4.8 on agentic coding benchmarks. DeepSuite score improved by ~5. API only. Vision capabilities added to V4 Flash. DeepSeek continues dominance in cost-performance ratio. Cost per intelligence: Fable $3.14 (most expensive) vs Luna Max $0.05 (cheapest frontier). DeepSeek V4 Pro raised prices from 5¢ to 25¢ — still 10x cheaper than American frontier models. Stripe buys OpenRouter for $7B (88% Forbes AI 50 on platform).",
        "quotes": []
      },
      {
        "title_pl": "🤖 DeepSeek harness 180K GitHub stars — rekord wszech czasów",
        "title_en": "🤖 DeepSeek harness 180K GitHub stars — all-time record",
        "body_pl": "DeepSeek harness: 173K→180K GitHub stars w tydzień — absolutny rekord. Modular open source: models, tools, sandboxes, storage, agent loops, scheduling — wszystko pluggable. Konfigurowalne agent presets, integracje z Claude Code i Codex. 'Bardzo raw, experimental' ale community zacznie poprawiać. Install: npx (jak Claude Code). Brak Python SDK. Claude Code = zamknięty (~500K lines), DeepSeek harness = open. Auto-design evolving harness (paper): nie trenuj LLM, ewoluuj harness. Focus shifting: better models → better harnesses.",
        "body_en": "DeepSeek harness: 173K→180K GitHub stars in a week — absolute record. Modular open source: models, tools, sandboxes, storage, agent loops, scheduling — everything pluggable. Configurable agent presets, integrations with Claude Code and Codex. 'Very raw, experimental' but community will start improving. Install: npx (like Claude Code). No Python SDK. Claude Code = closed (~500K lines), DeepSeek harness = open. Auto-design evolving harness (paper): don't train LLM, evolve harness. Focus shifting: better models → better harnesses.",
        "quotes": []
      },
      {
        "title_pl": "🏆 Avo — Claude Opus 5 → 100% ARC AGI 3",
        "title_en": "🏆 Avo — Claude Opus 5 → 100% ARC AGI 3",
        "body_pl": "Avo — agentic framework/harness który pozwala Claude Opus 5 osiągnąć 100% na ARC AGI 3 benchmark. Większość modeli <10%. Humans solve easily ale AI nie. Avo = breakthrough w agentic reasoning. To pokazuje że harness/scaffolding może substantially improve fixed models bez fine-tuning weights. Loop engineering: goal-driven agents repeatedly reason, act, observe, evaluate, revise. Harness engineering: context, memory, MCP, model routing, guardrails, tracing.",
        "body_en": "Avo — agentic framework/harness that allows Claude Opus 5 to achieve 100% on ARC AGI 3 benchmark. Most models <10%. Humans solve easily but AI cannot. Avo = breakthrough in agentic reasoning. This shows that harness/scaffolding can substantially improve fixed models without fine-tuning weights. Loop engineering: goal-driven agents repeatedly reason, act, observe, evaluate, revise. Harness engineering: context, memory, MCP, model routing, guardrails, tracing.",
        "quotes": []
      },
      {
        "title_pl": "🏃 Roboty biją ludzkie rekordy — Superman 12.7 m/s, jump 2m",
        "title_en": "🏃 Robots break human records — Superman 12.7 m/s, jump 2m",
        "body_pl": "Unitree humanoid robot — 3 miesiące development, pobił wszystkie human standing jump i speed records: 12.66 m/s (Usain Bolt). Superman robot (Booster): standing high jump 2m (ludzki rekord 1.8m), top speed 12.7 m/s. Designed to run so fast it cannot really stop. Honor Lightning robot — sprinting, outruns humans. Gen 1.5 (UBTech) — robot foundation model, uczy się task z pojedynczego video, 100x real-time. Humanoid Games — ceremonia z Tienong robotami. Emad: superhuman robots będą banned from streets — jak cars, accidents.",
        "body_en": "Unitree humanoid robot — 3 months development, broke all human standing jump and speed records: 12.66 m/s (Usain Bolt). Superman robot (Booster): standing high jump 2m (human record 1.8m), top speed 12.7 m/s. Designed to run so fast it cannot really stop. Honor Lightning robot — sprinting, outruns humans. Gen 1.5 (UBTech) — robot foundation model, learns task from single video, 100x real-time. Humanoid Games — ceremony with Tienong robots. Emad: superhuman robots will be banned from streets — like cars, accidents.",
        "quotes": []
      },
      {
        "title_pl": "🧬 Moderna mRNA cancer vaccine + Ado cell simulator",
        "title_en": "🧬 Moderna mRNA cancer vaccine + Ado cell simulator",
        "body_pl": "Moderna personalized cancer vaccine — pozytywne wyniki. Vaccine works by sequencing patient's tumor mutations, identifying neo antigens, manufacturing mRNA encoding up to 34 patient-specific antigen targets. Alex: to primitive nanobots — pierwsze successful nanotech w medicine. Ado (AI DΩ) — general purpose cell simulator. First world model of a human cell — predicts what happens at every level. David Baker (2024 Nobel Prize Chemistry z Demis for protein folding) co-founded. Alex: 'Medicine is cooked'. Foothills of longevity escape velocity.",
        "body_en": "Moderna personalized cancer vaccine — positive results. Vaccine works by sequencing patient's tumor mutations, identifying neo antigens, manufacturing mRNA encoding up to 34 patient-specific antigen targets. Alex: these are primitive nanobots — first successful nanotech in medicine. Ado (AI DΩ) — general purpose cell simulator. First world model of a human cell — predicts what happens at every level. David Baker (2024 Nobel Prize Chemistry with Demis for protein folding) co-founded. Alex: 'Medicine is cooked'. Foothills of longevity escape velocity.",
        "quotes": []
      },
      {
        "title_pl": "💾 Memory bottleneck — 500% price jump, HBM = post-von Neumann",
        "title_en": "💾 Memory bottleneck — 500% price jump, HBM = post-von Neumann",
        "body_pl": "Memory prices climbed 500% w 12 miesięcy — hyperscalers lock in DRAM production through 2027. SK Hynix CEO: 2027 będzie najgorszy rok dla memory supply. Tylko 2% światowej pamięci made in US. Elon's Terrafab będzie manufacture memory in-house. Global production rises 20% annually, AI demand 200%. Alex: HBM (high bandwidth memory) = 3D architecture, memory layers na top of compute. Memory = 1/3 infrastructure spend, next year 50%. Post-von Neumann architecture.",
        "body_en": "Memory prices climbed 500% in 12 months — hyperscalers lock in DRAM production through 2027. SK Hynix CEO: 2027 will be worst year for memory supply. Only 2% of world's memory made in US. Elon's Terrafab will manufacture memory in-house. Global production rises 20% annually, AI demand 200%. Alex: HBM (high bandwidth memory) = 3D architecture, memory layers on top of compute. Memory = 1/3 infrastructure spend, next year 50%. Post-von Neumann architecture.",
        "quotes": []
      },
      {
        "title_pl": "📊 Anthropic $2T IPO + hive mind + mind viruses",
        "title_en": "📊 Anthropic $2T IPO + hive mind + mind viruses",
        "body_pl": "Anthropic przygotowuje largest IPO w history. PolyMarket: ~$2 trillion (większe niż SpaceX). 89% betterzy mówią że happens przed końcem roku. Super voting class dla Dario. Stanford paper 'artificial hive mind' — modele zbiegają się towards single reasoning architecture. Anthropic paper: mind viruses mogą spread między AI agents. Alex: monoculture niebezpieczny — jedna choroba wyciepi wszystko. Dario: AI może cure all human disease. Alex: business model = marketing dla recursive self-improvement.",
        "body_en": "Anthropic preparing largest IPO in history. PolyMarket: ~$2 trillion (bigger than SpaceX). 89% of bettors say it happens before end of year. Super voting class for Dario. Stanford paper 'artificial hive mind' — models converging towards single reasoning architecture. Anthropic paper: mind viruses can spread between AI agents. Alex: monoculture dangerous — one disease wipes everything. Dario: AI can cure all human disease. Alex: business model = marketing for recursive self-improvement.",
        "quotes": []
      },
      {
        "title_pl": "🇨🇳 Chiny — WACO, AI Plus plan, GLM 5.3 cybersecurity bije MIUS",
        "title_en": "🇨🇳 China — WACO, AI Plus plan, GLM 5.3 cybersecurity beats MIUS",
        "body_pl": "Alvin Graylin (Diamandis #281): Chiny nie wierzą w ASI 'tuż-tuż' — CAC review każdy model. 30+ prowincji rywalizuje. WACO (World AI Cooperative Organization) — 26 narodów podpisało. Plan 'AI Plus' — 90% adopcji w 10 lat. GLM 5.3 cybersecurity bije MIUS 84.5% vs 83.8% (open > closed). Chiny budują 10x więcej energii niż USA. 90% komponentów robotów z Chin — US firms smugglują w walizkach. Stag hunt, nie prisoner's dilemma — koordynacja > zdrada. Buffett indicator 240% GDP — $1.7T AI bubble.",
        "body_en": "Alvin Graylin (Diamandis #281): China doesn't believe ASI is 'around the corner' — CAC reviews every model. 30+ provinces compete. WACO (World AI Cooperative Organization) — 26 nations signed. 'AI Plus' plan — 90% adoption in 10 years. GLM 5.3 cybersecurity beats MIUS 84.5% vs 83.8% (open > closed). China builds 10x more energy than US. 90% robot components from China — US firms smuggle in suitcases. Stag hunt, not prisoner's dilemma — coordination > betrayal. Buffett indicator 240% GDP — $1.7T AI bubble.",
        "quotes": []
      },
      {
        "title_pl": "🎨 Nowe modele i narzędzia — Evoke, Ornith 1.5, Audio8, Bernini v2",
        "title_en": "🎨 New models and tools — Evoke, Ornith 1.5, Audio8, Bernini v2",
        "body_pl": "Evoke — open-source interaktywny świat (obraz + joystick → video real-time). 4DAnyone — 4D gaussian splat character animation. SenseNova U1.5 — realistic photos, posters. Bernini v2 (ByteDance) — video editor 180GB. Ornith 1.5 — open-source LLM z self-improvement loop (9B + 35B MoE). Audio8 TTS 0.1B — tiny TTS, 0.1B params. GeoWeaver — long video chunks. Qwen Video Edit (41GB). Comfy MCP — AI agent controls ComfyUI via natural language. 12 nowych modeli dodanych do bazy (219 total).",
        "body_en": "Evoke — open-source interactive world (image + joystick → video real-time). 4DAnyone — 4D gaussian splat character animation. SenseNova U1.5 — realistic photos, posters. Bernini v2 (ByteDance) — video editor 180GB. Ornith 1.5 — open-source LLM with self-improvement loop (9B + 35B MoE). Audio8 TTS 0.1B — tiny TTS, 0.1B params. GeoWeaver — long video chunks. Qwen Video Edit (41GB). Comfy MCP — AI agent controls ComfyUI via natural language. 12 new models added to database (219 total).",
        "quotes": []
      },
      {
        "title_pl": "📡 Podsumowanie tygodnia — 219 modeli, 373 wydarzeń",
        "title_en": "📡 Week summary — 219 models, 373 events",
        "body_pl": "Tydzień 17-23 sierpnia 2026: 3 materiały przetworzone (Lev 21.08, Diamandis #282, AI Search ##34-1). 12 nowych modeli (219 total). 3 nowe benchmarki (Cost Per Intelligence, Cyber Gym, Frontend Code Arena). 7 nowych terminów słownika (154 total). Kluczowe tematy: OpenAI pauzuje, 100x reality, DeepSeek harness 180K stars, Avo 100% ARC AGI 3, roboty biją Usain Bolta, memory bottleneck, Anthropic $2T IPO, Moderna cancer vaccine. Pipeline: process_material.py + pipeline_check.py działają. Bilingual overhaul v10.0 complete.",
        "body_en": "Week of August 17-23, 2026: 3 materials processed (Lev 21.08, Diamandis #282, AI Search ##34-1). 12 new models (219 total). 3 new benchmarks (Cost Per Intelligence, Cyber Gym, Frontend Code Arena). 7 new glossary terms (154 total). Key topics: OpenAI pauses, 100x reality, DeepSeek harness 180K stars, Avo 100% ARC AGI 3, robots beat Usain Bolt, memory bottleneck, Anthropic $2T IPO, Moderna cancer vaccine. Pipeline: process_material.py + pipeline_check.py working. Bilingual overhaul v10.0 complete.",
        "quotes": []
      }
    ],
    "sources": [
      "Lev Selector (Kd27bA-yeqk) — 21.08.2026",
      "Diamandis Moonshots (TaJH0D2FKN8) — 21.08.2026 (#282)",
      "AI Search (rQ4yX5qNYdY) — 23.08.2026 (##34-1)"
    ]
  },
  {
    "num": 33,
    ...
    "sections": [
      ...
      {
        "title_pl": "🤖 Zastosuj rewolucję — Prime Agent 95.5% ARC AGI 3, Harness-R1, Gauntlet Loop",
      ...
      {
        "title_pl": "🏛️ Bernie Sanders pauza + wirusy AI (EVO2) — debata o biobezpieczeństwie",
      ...
      {
        "title_pl": "💻 Przemysł — NVIDIA 500B Wall Street, moc obliczeniowa jako aktywo handlowe (Ornn)",
      ...
      {
        "title_pl": "🏗️ Architektura — Nemotron 3.5 Lightning (Mamba 2), post-transformer",
      ...
      {
        "title_pl": "🎬 Rewolucja w Hollywood — film Higsfield za 2M $ z AI, LTX 2.5 kontra Minimax",
      ...
      {
        "title_pl": "� Benchmarks — LM Arena, koszt na inteligencję, GLM 5.3 cyberbezpieczeństwo",
      ...
      {
        "title_pl": "🌍 Symulacja — agenci person MatrAIx 8.3B, miliard agentów z Chin, Dyna 2",
  ...
  },
  {
    ...
    "sections": [
      {
        "title_pl": "🔧 Przebudowa kierownictwa Google — Jeff Dean odchodzi, Hassabis awansuje",
      ...
      {
        "title_pl": "🤖 Robotyka — Xiaomi, UBTECH rojowy, wózek inwalidzki Neuralink, spawanie Gen1, Hunyuan3D",
      ...
      {
        "title_pl": "💻 Programowanie + Narzędzia — Muse Code, Claude /doctor, Long Horizon Harness, GraphRAG",
      ...
      {
        "title_pl": "🦠 Medycyna + Nauka — ClinFusion, WeatherNext 2, Wielki Wybuch samorozwijający się",
      ...
      {
        "title_pl": "🏛️ Zmiany w branży — dominacja Rusta, ZLUDA, GenOffice, Meta Compute",
      ...
      {
        "title_pl": "💰 Pieniądze + Zawodnicy — HARK $4B, Aschenbrenner, SpaceX $100B ARR",
      ...
      {
        "title_pl": "� Benchmarks — LM Arena, Koszt Inteligencji na Jednostkę, Muse Spark positioning",
  ...
  },
  {
    ...
    "sections": [
      ...
      {
        "title_pl": "💰 DeepSeek V4 Flash 0731 — najtańsza inteligencja graniczna (3 centów/M tokenów)",
      ...
      {
        "title_pl": "🎨 Modele wideo — Seedance 2.5, Minimax H3, Wonder, Phi Zero",
      ...
      {
        "title_pl": "💻 Programowanie + Rust — Przepisano Llama.cpp, JCode, Topcode, usunięto 80% promptów Anthropic",
      ...
      {
        "title_pl": "🛠️ Narzędzia i Techniki — Fuzja modeli vs routing, OpenRouter, SGLang",
  ...
  },
  {
    ...
    "sections": [
      ...
      {
        "title_pl": "💻 Kodowanie — Laguna S2.1 (przy basenie), Claude Code, om router",
      ...
      {
        "title_pl": "⚪ Google — Gemini 3.6 Flash, przełom kwantowy",
      ...
      {
        "title_pl": "🛠️ Narzędzia i Techniki — nagrywanie umiejętności, KMS/HSM, remove-slop",
  ...
  },
  {
    ...
    "sections": [
      ...
      {
        "title_pl": "Rekursywna samodoskonalenie się — zdarzenie wstępne do zapłonu",
