...
const RELEASES = [
  {
    "num": "##37-1",
    "date": "2026-09-13",
    "title_pl": "AI Search ##37-1 — DeepSeek V4.1 Flash, AlphaGenome Atlas, AuK, YuE2, Navier-Stokes, Lingbot World 2",
    "title_en": "AI Search ##37-1 — DeepSeek V4.1 Flash, AlphaGenome Atlas, AuK, YuE2, Navier-Stokes, Lingbot World 2",
    "yt": "nZYJdwM-_nI",
    "collapsed": true,
    "items": [
      {
        "title_pl": "Marigold v2 — depth i surface normals z obrazu, pixel-level",
        "title_en": "Marigold v2 — depth and surface normals from image, pixel-level",
        "vendor": "Huawei",
        "category_pl": "Image Generation",
        "category_en": "Image Generation",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "Marigold v2 — bierze zwykły obraz, konwertuje na depth map, surface normals, albedo, etc. Pixel-level super high resolution. Beats Moji 3, Infinidepth. 17GB VRAM na high res, 29GB na top res. Wydane już na HuggingFace.",
        "review_en": "Marigold v2 — takes regular image, converts to depth map, surface normals, albedo, etc. Pixel-level super high resolution. Beats Moji 3, Infinidepth. 17GB VRAM for high res, 29GB for top res. Released on HuggingFace.",
        "links": []
      },
      {
        "title_pl": "Unimate — animuje dowolny 3D skeleton (Garfield, dragon, satellite)",
        "title_en": "Unimate — animates any 3D skeleton (Garfield, dragon, satellite)",
        "vendor": "Open-source",
        "category_pl": "Animation",
        "category_en": "Animation",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "Unimate — jeden model animuje dowolny 3D skeleton: flowers, Garfield, satellite, dragon. Standardowe modele animacji tylko human. Daj rigged 3D model + text instruction → motion automat. Training code released, fully open source.",
        "review_en": "Unimate — single model animates any 3D skeleton: flowers, Garfield, satellite, dragon. Standard animation models only human. Give rigged 3D model + text instruction → automatic motion. Training code released, fully open source.",
        "links": []
      },
      {
        "title_pl": "AlphaGenome Atlas — 9 mld mutacji przewidzianych, 1 petabajt",
        "title_en": "AlphaGenome Atlas — 9 billion mutations predicted, 1 petabyte",
        "vendor": "Google DeepMind",
        "category_pl": "AI Research",
        "category_en": "AI Research",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "AlphaGenome Atlas — Google DeepMind. 9 mld possible single-letter mutations w human genome precomputed. 1 petabyte dataset (30x AlphaFold DB). AVI score — impact score. 22% more genetic associations in UK Biobank. Helped solve unsolved rare disease. Atlas released for everyone.",
        "review_en": "AlphaGenome Atlas — Google DeepMind. 9B possible single-letter mutations in human genome precomputed. 1 petabyte dataset (30x AlphaFold DB). AVI score — impact score. 22% more genetic associations in UK Biobank. Helped solve unsolved rare disease. Atlas released for everyone.",
        "links": []
      },
      {
        "title_pl": "Lingbot World 2 — real-time interactive world, 720p@60fps, NPCs",
        "title_en": "Lingbot World 2 — real-time interactive world, 720p@60fps, NPCs",
        "vendor": "Open-source",
        "category_pl": "World Models",
        "category_en": "World Models",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "Lingbot World 2 — real-time interactive world model. 720p@60fps. NPCs zachowują się w świecie. Generuje interactive worlds przez 1h. Under the hood: Alibaba 1 2.2 jako video generator. Chunk-by-chunk generation + cache. 14B (high quality) lub 1.3B (faster).",
        "review_en": "Lingbot World 2 — real-time interactive world model. 720p@60fps. NPCs behave in world. Generates interactive worlds for 1h. Under the hood: Alibaba 1 2.2 as video generator. Chunk-by-chunk generation + cache. 14B (high quality) or 1.3B (faster).",
        "links": []
      },
      {
        "title_pl": "Isaac 0.5 — robot foundation model, 36B sparse, 35 robot systems",
        "title_en": "Isaac 0.5 — robot foundation model, 36B sparse, 35 robot systems",
        "vendor": "Perceptron",
        "category_pl": "Robotics",
        "category_en": "Robotics",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "Isaac 0.5 — robot foundation model. 36B sparse params (tiny). Trained na 35+ robot systems. 100K godzin robot experience + 1M godzin general video. Video understanding + spatial reasoning + future state prediction + physical actions trained together w 1 backbone. Open source.",
        "review_en": "Isaac 0.5 — robot foundation model. 36B sparse params (tiny). Trained on 35+ robot systems. 100K hours robot experience + 1M hours general video. Video understanding + spatial reasoning + future state prediction + physical actions trained together in 1 backbone. Open source.",
        "links": []
      },
      {
        "title_pl": "World Sculpt — scene → individual 3D objects, edytowalne",
        "title_en": "World Sculpt — scene → individual 3D objects, editable",
        "vendor": "Alaya Lab",
        "category_pl": "3D Generation",
        "category_en": "3D Generation",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "World Sculpt — bierze scene (multi-image lub video), tworzy 3D scene z osobnymi edytowalnymi obiektami. Resize, move, edit individually. Konwertuje gaussian splat worlds na actual 3D mesh scenes. Released.",
        "review_en": "World Sculpt — takes scene (multi-image or video), creates 3D scene with separate editable objects. Resize, move, edit individually. Converts gaussian splat worlds into actual 3D mesh scenes. Released.",
        "links": []
      },
      {
        "title_pl": "Fire3D — photos/video → 3D scene z osobnymi obiektami, <1 min",
        "title_en": "Fire3D — photos/video → 3D scene with separate objects, <1 min",
        "vendor": "Open-source",
        "category_pl": "3D Generation",
        "category_en": "3D Generation",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "Fire3D — photos lub video → complete 3D scene z osobnymi edytowalnymi obiektami. Simulation-ready. Każdy obiekt = own mesh + material. <1 min. 16 obiektów parallel na 1 GPU. Training code released.",
        "review_en": "Fire3D — photos or video → complete 3D scene with separate editable objects. Simulation-ready. Each object = own mesh + material. <1 min. 16 objects parallel on 1 GPU. Training code released.",
        "links": []
      },
      {
        "title_pl": "AuK — Nano Banana dla speech, microedit, zero-shot clone, 6.12 GB",
        "title_en": "AuK — Nano Banana for speech, microedit, zero-shot clone, 6.12 GB",
        "vendor": "Tencent",
        "category_pl": "Audio",
        "category_en": "Audio",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "AuK (Tencent) — Nano Banana dla speech. TTS z voice description. Zero-shot voice clone. Microedit: add/delete words seamless. Noise removal, voice enhancement, resolution increase. Emotion change (sad/angry). Timbre change (male→female). Whisper mode. 6.12GB — fits na consumer GPUs.",
        "review_en": "AuK (Tencent) — Nano Banana for speech. TTS with voice description. Zero-shot voice clone. Microedit: add/delete words seamlessly. Noise removal, voice enhancement, resolution increase. Emotion change (sad/angry). Timbre change (male→female). Whisper mode. 6.12GB — fits on consumer GPUs.",
        "links": []
      },
      {
        "title_pl": "DeepSeek V4.1 Flash — 552B MoE, encoder+decoder, #1 Deep Suite",
        "title_en": "DeepSeek V4.1 Flash — 552B MoE, encoder+decoder, #1 Deep Suite",
        "vendor": "DeepSeek",
        "category_pl": "LLM",
        "category_en": "LLM",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "DeepSeek V4.1 Flash — 552B MoE (8-16B active). Nowa architecture: encoder+decoder (większość LLM ma tylko decoder). Engram feature, sliding window attention, CSA 2 attention. #1 Deep Suite 1.1 (74.2, beats GPT-6 Astra). 217 tok/s przez API (3x GLM, 7x Kimi K3). Najtańszy frontier model. Open source 510GB, GGUF Q1 = 106GB.",
        "review_en": "DeepSeek V4.1 Flash — 552B MoE (8-16B active). New architecture: encoder+decoder (most LLMs have only decoder). Engram feature, sliding window attention, CSA 2 attention. #1 Deep Suite 1.1 (74.2, beats GPT-6 Astra). 217 tok/s via API (3x GLM, 7x Kimi K3). Cheapest frontier model. Open source 510GB, GGUF Q1 = 106GB.",
        "links": []
      },
      {
        "title_pl": "OpenAI Navier-Stokes rozwiązany — 10K agents, 88h, internal model",
        "title_en": "OpenAI Navier-Stokes solved — 10K agents, 88h, internal model",
        "vendor": "OpenAI",
        "category_pl": "AI Research",
        "category_en": "AI Research",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "OpenAI rozwiązał Navier-Stokes Millennium Prize. Forced non-Euler problem (z viscosity, trudniejszy niż Euler). 10K concurrent agents, 88h, internal model (significantly better niż GPT-6 Astra). Whirlpool z specific conditions → vortex stretching into infinity = singularity (blowup). Nie rozwiązano unforced problem (bez external force). 90 lat unsolved by humans. Genuine breakthrough.",
        "review_en": "OpenAI solved Navier-Stokes Millennium Prize. Forced non-Euler problem (with viscosity, harder than Euler). 10K concurrent agents, 88h, internal model (significantly better than GPT-6 Astra). Whirlpool with specific conditions → vortex stretching into infinity = singularity (blowup). Unforced problem (no external force) still unsolved. 90 years unsolved by humans. Genuine breakthrough.",
        "links": []
      },
      {
        "title_pl": "Show Harness — VLM jako robot controller, 100% success",
        "title_en": "Show Harness — VLM as robot controller, 100% success",
        "vendor": "Show Lab",
        "category_pl": "Robotics",
        "category_en": "Robotics",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "Show Harness — can we use vision language models to control robots? VLM + list of movements → robot actions. Plug through robot-specific action interpreter. 100% success achievable. Plug any VLM (Gemini, GPT, Qwen, GLM). GitHub repo released.",
        "review_en": "Show Harness — can we use vision language models to control robots? VLM + list of movements → robot actions. Plug through robot-specific action interpreter. 100% success achievable. Plug any VLM (Gemini, GPT, Qwen, GLM). GitHub repo released.",
        "links": []
      },
      {
        "title_pl": "Edge0 — MoE on low-memory devices, Qwen 35B w 2.9GB RAM",
        "title_en": "Edge0 — MoE on low-memory devices, Qwen 35B in 2.9GB RAM",
        "vendor": "Edge0 AI",
        "category_pl": "LLM",
        "category_en": "LLM",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "Edge0 — run MoE on machines bez enough RAM. Qwen 3.5 35B normally needs full 35B loaded. Edge0 streams only experts the model actually needs. Int4 compressed + RecoverLoRA dla quality. Qwen 35B w 2.9GB RAM. 8B variant w 1GB. Based on Inclusion AI's Ling 3.0 tiny.",
        "review_en": "Edge0 — run MoE on machines without enough RAM. Qwen 3.5 35B normally needs full 35B loaded. Edge0 streams only experts the model actually needs. Int4 compressed + RecoverLoRA for quality. Qwen 35B in 2.9GB RAM. 8B variant in 1GB. Based on Inclusion AI's Ling 3.0 tiny.",
        "links": []
      },
      {
        "title_pl": "RealSWE — benchmark real software engineering, Fable 5.1 #1 38.8%",
        "title_en": "RealSWE — benchmark real software engineering, Fable 5.1 #1 38.8%",
        "vendor": "Specific",
        "category_pl": "Benchmark",
        "category_en": "Benchmark",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "RealSWE — real software engineering benchmark. Daje agents private company code + asks business-relevant changes (invoice taxes, customer migration). Harder niż Swebench/Deep Suite (saturated). Fable 5.1 #1 = 38.8%, GPT-6 Astra 33.8%, Gemini 3.8 Flash #3, GLM 5.3 #4. Top 4 statistically tied.",
        "review_en": "RealSWE — real software engineering benchmark. Gives agents private company code + asks business-relevant changes (invoice taxes, customer migration). Harder than Swebench/Deep Suite (saturated). Fable 5.1 #1 = 38.8%, GPT-6 Astra 33.8%, Gemini 3.8 Flash #3, GLM 5.3 #4. Top 4 statistically tied.",
        "links": []
      },
      {
        "title_pl": "Suno V6 — music generation + microediting, V6/Wild/Mini",
        "title_en": "Suno V6 — music generation + microediting, V6/Wild/Mini",
        "vendor": "Suno",
        "category_pl": "Audio",
        "category_en": "Audio",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "Suno V6 — music generation + microediting. Change single lyric bez reszty piosenki. Combine vocals z jednej song z instrumentem z drugiej. Izoluj guitar riff. V6 (paid, precise), V6 Wild (paid, varied), V6 Mini (free, faster, less precise). Closed source, recent restrictions (download limits).",
        "review_en": "Suno V6 — music generation + microediting. Change single lyric without affecting rest of song. Combine vocals from one song with instrument from another. Isolate guitar riff. V6 (paid, precise), V6 Wild (paid, varied), V6 Mini (free, faster, less precise). Closed source, recent restrictions (download limits).",
        "links": []
      },
      {
        "title_pl": "YuE2 — open-source music gen z musical plan first, 7.3GB",
        "title_en": "YuE2 — open-source music gen with musical plan first, 7.3GB",
        "vendor": "Open-source",
        "category_pl": "Audio",
        "category_en": "Audio",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "YuE2 — open-source music generator. Composes musical plan FIRST (melody, rhythm, chords, structure), potem full song z vocals + accompaniment. Edit score further. Covers (Jingle Bells minor key). Better niż Suno V6 w benchmarks (their claim). Beats Minimax Music 3, AEP 1.5. 7.3GB — consumer GPUs.",
        "review_en": "YuE2 — open-source music generator. Composes musical plan FIRST (melody, rhythm, chords, structure), then full song with vocals + accompaniment. Edit score further. Covers (Jingle Bells minor key). Better than Suno V6 on benchmarks (their claim). Beats Minimax Music 3, AEP 1.5. 7.3GB — consumer GPUs.",
        "links": []
      },
      {
        "title_pl": "ChatGPT for Financial Services — Astra + financial data, sales-only",
        "title_en": "ChatGPT for Financial Services — Astra + financial data, sales-only",
        "vendor": "OpenAI",
        "category_pl": "LLM",
        "category_en": "LLM",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "ChatGPT for Financial Services — GPT-6 Astra + financial data (Pitchbook, Crunchbase). Investigate companies, build financial models, output spreadsheets/docs/presentations. Trace figures back to specific tables/passages. Firms can supply own templates. Contact sales — nie dla wszystkich.",
        "review_en": "ChatGPT for Financial Services — GPT-6 Astra + financial data (Pitchbook, Crunchbase). Investigate companies, build financial models, output spreadsheets/docs/presentations. Trace figures back to specific tables/passages. Firms can supply own templates. Contact sales — not for everyone.",
        "links": []
      },
      {
        "title_pl": "UMR — Unified Motion Retargeting, human motion → robot",
        "title_en": "UMR — Unified Motion Retargeting, human motion → robot",
        "vendor": "Open-source",
        "category_pl": "Robotics",
        "category_en": "Robotics",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "UMR (Unified Motion Retargeting) — tłumaczy human movements na robot movements. Reprezentuje surfaces jako 3D points, learns which points correspond. Preserves contact z objects/environment. Spin kicks, climbing stairs, tennis. Reuse human motion data across different robots.",
        "review_en": "UMR (Unified Motion Retargeting) — translates human movements into robot movements. Represents surfaces as 3D points, learns which points correspond. Preserves contact with objects/environment. Spin kicks, climbing stairs, tennis. Reuse human motion data across different robots.",
        "links": []
      },
      {
        "title_pl": "UnifoLM WLA — 6B params robot model, 64 tasks, 9GB",
        "title_en": "UnifoLM WLA — 6B params robot model, 64 tasks, 9GB",
        "vendor": "Open-source",
        "category_pl": "Robotics",
        "category_en": "Robotics",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "UnifoLM WLA — open-source robot model, 6B params. 64 tasks (54 tabletop + 10 whole body coordination). 2-finger grippers + 5-finger robot hands. Robot uczy się predict which parts of scene change during interaction. Whole body coordination: laundry, bottle→trash, kitchen manipulation. <9GB — fits locally offline. Training data released.",
        "review_en": "UnifoLM WLA — open-source robot model, 6B params. 64 tasks (54 tabletop + 10 whole body coordination). 2-finger grippers + 5-finger robot hands. Robot learns to predict which parts of scene change during interaction. Whole body coordination: laundry, bottle→trash, kitchen manipulation. <9GB — fits locally offline. Training data released.",
        "links": []
      },
      {
        "title_pl": "MiniCPM5 2B — tiny 2B dense model, SOTA dla small size, 5GB",
        "title_en": "MiniCPM5 2B — tiny 2B dense model, SOTA for small size, 5GB",
        "vendor": "OpenBMB",
        "category_pl": "LLM",
        "category_en": "LLM",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "MiniCPM5 2B (OpenBMB) — super tiny 2B dense model. SOTA dla similar sizes — better niż Qwen 3.5 4B w code reasoning, math, instruction following, general knowledge. 5GB — fits na most consumer devices. Training dataset also released.",
        "review_en": "MiniCPM5 2B (OpenBMB) — super tiny 2B dense model. SOTA for similar sizes — better than Qwen 3.5 4B on code reasoning, math, instruction following, general knowledge. 5GB — fits on most consumer devices. Training dataset also released.",
        "links": []
      },
      {
        "title_pl": "Higgsfield — all-in-one AI creative platform + GPT-6 Astra + After Effects",
        "title_en": "Higgsfield — all-in-one AI creative platform + GPT-6 Astra + After Effects",
        "vendor": "Higgsfield",
        "category_pl": "Video Generation",
        "category_en": "Video Generation",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "Higgsfield — all-in-one AI creative platform. GPT-6 Astra wewnątrz ChatGPT do planowania + promptów, Higgsfield generuje visuals. New AI Motion Designer connects Astra → After Effects. Editable project z layers, shapes, expressions. Animation reference → recreate. Reusable plug-in. Product ads, cinematic videos, motion graphics.",
        "review_en": "Higgsfield — all-in-one AI creative platform. GPT-6 Astra inside ChatGPT for planning + prompts, Higgsfield generates visuals. New AI Motion Designer connects Astra → After Effects. Editable project with layers, shapes, expressions. Animation reference → recreate. Reusable plug-in. Product ads, cinematic videos, motion graphics.",
        "links": []
      },
      {
        "title_pl": "Lingbot World 2 14B / 1.3B — Alibaba 1 2.2 + chunk streaming",
        "title_en": "Lingbot World 2 14B / 1.3B — Alibaba 1 2.2 + chunk streaming",
        "vendor": "Open-source",
        "category_pl": "World Models",
        "category_en": "World Models",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "Lingbot World 2 variants — 14B (high quality) lub 1.3B (faster). Alibaba 1 2.2 jako video generator, chunk-by-chunk generation dla real-time streaming. Caches previous information — retains memory of scene. NPCs w środowisku.",
        "review_en": "Lingbot World 2 variants — 14B (high quality) or 1.3B (faster). Alibaba 1 2.2 as video generator, chunk-by-chunk generation for real-time streaming. Caches previous information — retains memory of scene. NPCs in environment.",
        "links": []
      },
      {
        "title_pl": "Marigold v2 benchmarks — #1 vs Moji 3, Infinidepth",
        "title_en": "Marigold v2 benchmarks — #1 vs Moji 3, Infinidepth",
        "vendor": "Huawei",
        "category_pl": "Image Generation",
        "category_en": "Image Generation",
        "date": "2026-09-12",
        "thumbnail": "https://i.ytimg.com/vi/nZYJdwM-_nI/hqdefault.jpg",
        "review_pl": "Marigold v2 — benchmark comparison. Pixel-level depth + surface normals + albedo. Beats Moji 3, Infinidepth na detal i accuracy. Sharper normal estimation. 17GB VRAM na high res, 29GB na top res.",
        "review_en": "Marigold v2 — benchmark comparison. Pixel-level depth + surface normals + albedo. Beats Moji 3, Infinidepth on detail and accuracy. Sharper normal estimation. 17GB VRAM for high res, 29GB for top res.",
        "links": []
      }
    ]
  },
  {
    "num": "##36-1",
    "date": "2026-09-06",
    "title_pl": "AI Search ##36-1 — GPT-6 Astra, Claude Fable 5.1, Gemini 3.8, realtime Minimax, Atlas",
    "title_en": "AI Search ##36-1 — GPT-6 Astra, Claude Fable 5.1, Gemini 3.8, realtime Minimax, Atlas",
    "yt": "rQ4yX5qNYdY",
    "collapsed": true,
    "items": [
      {
        "title_pl": "GameGenX — video model → real-time interactive worlds",
        "title_en": "GameGenX — video model to real-time interactive worlds",
        "vendor": "Open-source",
        "category_pl": "World Models",
        "category_en": "World Models",
        "date": "2026-09-05",
        "thumbnail": "https://i.ytimg.com/vi/rQ4yX5qNYdY/hqdefault.jpg",
        "review_pl": "GameGenX — konwertuje video models do real-time interactive worlds. Nie buduje nowego control system — używa istniejącego. Keep generating worlds consistently. Code released na GitHub. Trening data, pipeline, recipes — wszystko open.",
        "review_en": "GameGenX — converts video models to real-time interactive worlds. Doesn't build new control system — uses existing. Keep generating worlds consistently. Code released on GitHub. Training data, pipeline, recipes — all open.",
        "links": []
      },
      {
        "title_pl": "Google TimesFM3 — 330M params, time series forecasting, #1",
        "title_en": "Google TimesFM3 — 330M params, time series forecasting, #1",
        "vendor": "Google",
        "category_pl": "AI Science Agents",
        "category_en": "AI Science Agents",
        "date": "2026-09-05",
        "thumbnail": "https://i.ytimg.com/vi/rQ4yX5qNYdY/hqdefault.jpg",
        "review_pl": "Google TimesFM3 — only 330M params. Pre-trained na >1 trillion time points. #1 across benchmarks (GIFT-Eval, ValvBench, time). Fits na most consumer devices. Tiny model dla difficult forecasting.",
        "review_en": "Google TimesFM3 — only 330M params. Pre-trained on >1 trillion time points. #1 across benchmarks (GIFT-Eval, ValvBench, time). Fits on most consumer devices. Tiny model for difficult forecasting.",
        "links": []
      },
      {
        "title_pl": "Lucida — 3D room reconstruction z images, object-level",
        "title_en": "Lucida — 3D room reconstruction from images, object-level",
        "vendor": "Open-source",
        "category_pl": "3D Generation",
        "category_en": "3D Generation",
        "date": "2026-09-05",
        "thumbnail": "https://i.ytimg.com/vi/rQ4yX5qNYdY/hqdefault.jpg",
        "review_pl": "Lucida — bierze images of room, identifies individual objects, builds complete 3D assets. Gizmo act placement predicts original locations. Object-level reconstruction nie full fused scan.",
        "review_en": "Lucida — takes images of room, identifies individual objects, builds complete 3D assets. Gizmo act placement predicts original locations. Object-level reconstruction not full fused scan.",
        "links": []
      },
      {
        "title_pl": "Video Deltaet — Minimax H3 faster than real-time (14s clip in 11s)",
        "title_en": "Video Deltaet — Minimax H3 faster than real-time (14s clip in 11s)",
        "vendor": "Open-source",
        "category_pl": "Video Generation",
        "category_en": "Video Generation",
        "date": "2026-09-05",
        "thumbnail": "https://i.ytimg.com/vi/rQ4yX5qNYdY/hqdefault.jpg",
        "review_pl": "Video Deltaet — attention = 85% of Minimax H3 runtime. Video Deltaet optymalizuje attention. Combined z optimized kernels, parallelism, 8-step distillation. 8x B200 = 14s clip w 11s = faster than real-time.",
        "review_en": "Video Deltaet — attention = 85% of Minimax H3 runtime. Video Deltaet optimizes attention. Combined with optimized kernels, parallelism, 8-step distillation. 8x B200 = 14s clip in 11s = faster than real-time.",
        "links": []
      },
      {
        "title_pl": "Lada Image — open-source image generator+editor, 6B params, 6.7GB FP8",
        "title_en": "Lada Image — open-source image generator+editor, 6B params, 6.7GB FP8",
        "vendor": "Open-source",
        "category_pl": "Image Generation",
        "category_en": "Image Generation",
        "date": "2026-09-05",
        "thumbnail": "https://i.ytimg.com/vi/rQ4yX5qNYdY/hqdefault.jpg",
        "review_pl": "Lada Image — open-source image generator + editor. 6B params. Turbo FP8 = 6.7GB. Realistic photos, posters, infographics. Edit text, colorize photos. Flexible tool na consumer devices.",
        "review_en": "Lada Image — open-source image generator + editor. 6B params. Turbo FP8 = 6.7GB. Realistic photos, posters, infographics. Edit text, colorize photos. Flexible tool on consumer devices.",
        "links": []
      },
      {
        "title_pl": "DeepSeek V4 Flash Vision — matches Opus 4.8, even beats non-vision V4 Flash",
        "title_en": "DeepSeek V4 Flash Vision — matches Opus 4.8, even beats non-vision V4 Flash",
        "vendor": "DeepSeek",
        "category_pl": "LLM",
        "category_en": "LLM",
        "date": "2026-09-05",
        "thumbnail": "https://i.ytimg.com/vi/rQ4yX5qNYdY/hqdefault.jpg",
        "review_pl": "DeepSeek V4 Flash z vision — beats non-vision V4 Flash, on par z Claude Opus 4.8. Flash model matching frontier. Vision capabilities added.",
        "review_en": "DeepSeek V4 Flash with vision — beats non-vision V4 Flash, on par with Claude Opus 4.8. Flash model matching frontier. Vision capabilities added.",
        "links": []
      },
      {
        "title_pl": "Qwen 3.8 Max 0904 — beats old version, some benchmarks >Opus 5 and GPT 5.6 Sol",
        "title_en": "Qwen 3.8 Max 0904 — beats old version, some benchmarks >Opus 5 and GPT 5.6 Sol",
        "vendor": "Alibaba",
        "category_pl": "LLM",
        "category_en": "LLM",
        "date": "2026-09-05",
        "thumbnail": "https://i.ytimg.com/vi/rQ4yX5qNYdY/hqdefault.jpg",
        "review_pl": "Qwen 3.8 Max 0904 — significantly beats old version. Over 10% improvement na some benchmarks. Beats Opus 5 and GPT 5.6 Sol na some. Agentic coding benchmarks impressive. Alibaba accelerating fast.",
        "review_en": "Qwen 3.8 Max 0904 — significantly beats old version. Over 10% improvement on some benchmarks. Beats Opus 5 and GPT 5.6 Sol on some. Agentic coding benchmarks impressive. Alibaba accelerating fast.",
        "links": []
      },
      {
        "title_pl": "Claude Fable 5.1 — Anthropic's latest, agentic but most expensive (3.7x GPT 5.6 Max)",
        "title_en": "Claude Fable 5.1 — Anthropic's latest, agentic but most expensive (3.7x GPT 5.6 Max)",
        "vendor": "Anthropic",
        "category_pl": "LLM",
        "category_en": "LLM",
        "date": "2026-09-05",
        "thumbnail": "https://i.ytimg.com/vi/rQ4yX5qNYdY/hqdefault.jpg",
        "review_pl": "Claude Fable 5.1 — best latest model Anthropic. Especially good w agentic. Ale by far most expensive — 3.7x more than GPT 5.6 Max. Despite claims dla scientific research, deep research + medical prompts were disappointing.",
        "review_en": "Claude Fable 5.1 — best latest model Anthropic. Especially good in agentic. But by far most expensive — 3.7x more than GPT 5.6 Max. Despite claims for scientific research, deep research + medical prompts were disappointing.",
        "links": []
      },
      {
        "title_pl": "Gemini 3.8 Flash — #8 na leaderboard, 348 tok/s, best price-performance",
        "title_en": "Gemini 3.8 Flash — #8 on leaderboard, 348 tok/s, best price-performance",
        "vendor": "Google",
        "category_pl": "LLM",
        "category_en": "LLM",
        "date": "2026-09-05",
        "thumbnail": "https://i.ytimg.com/vi/rQ4yX5qNYdY/hqdefault.jpg",
        "review_pl": "Gemini 3.8 Flash — #8 na arena leaderboard. 348 tok/s — far higher than competitors. SOTA w scientific figures, charts, long video. Deep Suite benchmark: long horizon agentic SE. Reasonable cost. Best price-performance.",
        "review_en": "Gemini 3.8 Flash — #8 on arena leaderboard. 348 tok/s — far higher than competitors. SOTA in scientific figures, charts, long video. Deep Suite benchmark: long horizon agentic SE. Reasonable cost. Best price-performance.",
        "links": []
      },
      {
        "title_pl": "Cyber model — 2.6x more correct patches to Chrome vulnerabilities",
        "title_en": "Cyber model — 2.6x more correct patches to Chrome vulnerabilities",
        "vendor": "Google",
        "category_pl": "Security",
        "category_en": "Security",
        "date": "2026-09-05",
        "thumbnail": "https://i.ytimg.com/vi/rQ4yX5qNYdY/hqdefault.jpg",
        "review_pl": "Google cyber model — 2.6x more correct patches to Chrome vulnerabilities vs best commercial models. Security-specific model dla vulnerability patching.",
        "review_en": "Google cyber model — 2.6x more correct patches to Chrome vulnerabilities vs best commercial models. Security-specific model for vulnerability patching.",
        "links": []
      },
      {
        "title_pl": "GPT-6 Astra — state-of-the-art, 100% on exploit gym, saturates benchmarks",
        "title_en": "GPT-6 Astra — state-of-the-art, 100% on exploit gym, saturates benchmarks",
        "vendor": "OpenAI",
        "category_pl": "LLM",
        "category_en": "LLM",
        "date": "2026-09-05",
        "thumbnail": "https://i.ytimg.com/vi/rQ4yX5qNYdY/hqdefault.jpg",
        "review_pl": "GPT-6 Astra — destroys all other models. SOTA na computer use, browsing, SE. 100% na exploit gym (completely destroying benchmark). 60%+ na game environment (vs <10% dla other frontier). Z adapter/harness → close to 100%. Frontier Math: Astra High. Music transcription. Terminal Bench 4. Cheaper niż Fable.",
        "review_en": "GPT-6 Astra — destroys all other models. SOTA on computer use, browsing, SE. 100% on exploit gym (completely destroying benchmark). 60%+ on game environment (vs <10% for other frontier). With adapter/harness → close to 100%. Frontier Math: Astra High. Music transcription. Terminal Bench 4. Cheaper than Fable.",
        "links": []
      },
      {
        "title_pl": "Google WeatherNext 3 — observation-based, 5x sharper, renewable energy",
        "title_en": "Google WeatherNext 3 — observation-based, 5x sharper, renewable energy",
        "vendor": "Google",
        "category_pl": "AI Science Agents",
        "category_en": "AI Science Agents",
        "date": "2026-09-05",
        "thumbnail": "https://i.ytimg.com/vi/rQ4yX5qNYdY/hqdefault.jpg",
        "review_pl": "Google WeatherNext 3 — observation-based zamiast weather simulations. 5x sharper resolution. Mountains, coastlines, storms, local rain. Predicts wind speeds at turbine height, solar irradiance. Renewable energy forecasting.",
        "review_en": "Google WeatherNext 3 — observation-based instead of weather simulations. 5x sharper resolution. Mountains, coastlines, storms, local rain. Predicts wind speeds at turbine height, solar irradiance. Renewable energy forecasting.",
        "links": []
      },
      {
        ...
        "date": "2026-09-05",
        "thumbnail": "https://i.ytimg.com/vi/rQ4yX5qNYdY/hqdefault.jpg",
        "review_pl": "FlyWire — largest nervous system reconstruction. Fruit fly: 166K neurons, 125M synapses. Cutting nervous system into enormous slices. Human = 86B neurons (can't map yet). Neuroscience understanding of brain circuits + behavior.",
        "review_en": "FlyWire — largest nervous system reconstruction. Fruit fly: 166K neurons, 125M synapses. Cutting nervous system into enormous slices. Human = 86B neurons (can't map yet). Neuroscience understanding of brain circuits + behavior.",
        "links": []
      },
      {
        "title_pl": "Atlas by World Labs (Fei-Fei Li) — 1min 1440p video, 3D geometry",
        "title_en": "Atlas by World Labs (Fei-Fei Li) — 1min 1440p video, 3D geometry",
        "vendor": "World Labs",
        "category_pl": "World Models",
        "category_en": "World Models",
        "date": "2026-09-05",
        "thumbnail": "https://i.ytimg.com/vi/rQ4yX5qNYdY/hqdefault.jpg",
        "review_pl": "Atlas (World Labs, Fei-Fei Li) — input video + manual camera path → 1 min 1440p coherent video. Freeze frame anytime = coherent. Explicit 3D geometry (point clouds, gaussian splats). Different from other world models.",
        "review_en": "Atlas (World Labs, Fei-Fei Li) — input video + manual camera path → 1 min 1440p coherent video. Freeze frame anytime = coherent. Explicit 3D geometry (point clouds, gaussian splats). Different from other world models.",
        "links": []
      },
      {
        "title_pl": "Intern Lumina U2 — diffusion LLM, multimodal understanding, ER diagrams",
        "title_en": "Intern Lumina U2 — diffusion LLM, multimodal understanding, ER diagrams",
        "vendor": "Open-source",
        "category_pl": "Multimodal",
        "category_en": "Multimodal",
        "date": "2026-09-05",
        "thumbnail": "https://i.ytimg.com/vi/rQ4yX5qNYdY/hqdefault.jpg",
        "review_pl": "Intern Lumina U2 — diffusion large model. Text-to-image generation + editing. Multimodal understanding: understands complicated ER diagrams, answers questions. Not just image generator — multimodal reasoner.",
        "review_en": "Intern Lumina U2 — diffusion large model. Text-to-image generation + editing. Multimodal understanding: understands complicated ER diagrams, answers questions. Not just image generator — multimodal reasoner.",
        "links": []
      },
      {
        "title_pl": "Vigle Animate — character swap w video z one edited frame",
        "title_en": "Vigle Animate — character swap in video with one edited frame",
        "vendor": "Open-source",
        "category_pl": "Video Generation",
        "category_en": "Video Generation",
        "date": "2026-09-05",
        "thumbnail": "https://i.ytimg.com/vi/rQ4yX5qNYdY/hqdefault.jpg",
        "review_pl": "Vigle Animate — swaps character w clip using one edited frame. Take video, give frame of new character, automatically applies original character's motion. Full Minimax fine-tune 66GB. Models released.",
        "review_en": "Vigle Animate — swaps character in clip using one edited frame. Take video, give frame of new character, automatically applies original character's motion. Full Minimax fine-tune 66GB. Models released.",
        "links": []
      },
      {
        "title_pl": "Autoregressive diffusion world model — no max duration, video+audio",
        "title_en": "Autoregressive diffusion world model — no max duration, video+audio",
        "vendor": "Open-source",
        "category_pl": "World Models",
        "category_en": "World Models",
        "date": "2026-09-05",
        "thumbnail": "https://i.ytimg.com/vi/rQ4yX5qNYdY/hqdefault.jpg",
        "review_pl": "Autoregressive diffusion world model — video + audio. No fixed maximum duration. Keeps looking at previous frames + generates next. Give initial image or description, places you in world.",
        "review_en": "Autoregressive diffusion world model — video + audio. No fixed maximum duration. Keeps looking at previous frames + generates next. Give initial image or description, places you in world.",
        "links": []
      },
      {
        "title_pl": "Higsfield — all-in-one AI creation platform, Cinema Studio",
        "title_en": "Higsfield — all-in-one AI creation platform, Cinema Studio",
        "vendor": "Higsfield",
        "category_pl": "Video Generation",
        "category_en": "Video Generation",
        "date": "2026-09-05",
        "thumbnail": "https://i.ytimg.com/vi/rQ4yX5qNYdY/hqdefault.jpg",
        "review_pl": "Higsfield — all-in-one AI creation platform dla creators. Idea → product concept → brand direction → visuals → launch video. Cinema Studio: end-to-end AI filmmaking pipeline. Cinematic control instead of hoping.",
        "review_en": "Higsfield — all-in-one AI creation platform for creators. Idea → product concept → brand direction → visuals → launch video. Cinema Studio: end-to-end AI filmmaking pipeline. Cinematic control instead of hoping.",
        "links": []
      }
    ]
  },
