...
const EPISODES = [
  {
    ...
    "collapsed": true,
    "channel": "Moonshots",
    "title": "Frontier Labs Want to Slow Down, OpenAI Delays Its 2026 IPO, Anthropic Flags 5 Bioweapon Cases | EP #288",
    "title_pl": "Laboratoria frontier chcą spowolnienia, OpenAI opóźnia IPO 2026, Anthropic flaguje 5 przypadków broni biologicznej | #288",
    "title_en": "Frontier Labs Want to Slow Down, OpenAI Delays Its 2026 IPO, Anthropic Flags 5 Bioweapon Cases | EP #288",
    "date": "2026-09-17",
    "duration": "155 min",
    "yt": "DrV4WwNEAZE",
    "hosts_count_pl": "4 uczestników (Emad nieobecny)",
    "hosts_count_en": "4 participants (Emad absent)",
    ...
    "topics": [
      {
        "num": "01",
        "title": "AI Leaders Call for a Slowdown",
        "title_pl": "Liderzy AI wzywają do spowolnienia",
        "title_en": "AI Leaders Call for a Slowdown",
        "time": "00:00 – 06:24",
        "fakty_pl": "Peter: 'the future of the entire industry just got renegotiated w past 72 hours.' Sobota: Dario Amodei (CEO Anthropic) 3800-word essay 'We must pace the frontier.' 3 godziny później: Sam Altman 'You're right.' Poniedziałek: Trump nazwał to hoax, Chiny cold war trick. Alex: 'clumsy decapitation attempt against the takeoff itself.' Sam Altman powiedział Fortune: OpenAI nie go public w 2026. Reuters: 'nawet 10% extinction risk would be unacceptable.' Peter: 'pure theater — nie chcesz IPO teraz, blame safety. Nie chcesz world government, blame safety. The dog ate my homework i safety ate my IPO.' Anthropic September threat intelligence report: 5 przypadków bioweapon-related activity z Claude. Bio red line przekroczony. 'AI regulation is going to happen.' Salim w Miami, leci do India (launching organizational singularity). Dave w Stanford, był w Google — Positron inference accelerator + Cerebrus (Andrew Feldman). Alex at SFO.",
        "fakty_en": "Peter: 'the future of the entire industry just got renegotiated in past 72 hours.' Saturday: Dario Amodei (CEO Anthropic) 3800-word essay 'We must pace the frontier.' 3 hours later: Sam Altman 'You're right.' Monday: Trump called it hoax, China cold war trick. Alex: 'clumsy decapitation attempt against the takeoff itself.' Sam Altman told Fortune: OpenAI not going public in 2026. Reuters: 'even a 10% extinction risk would be unacceptable.' Peter: 'pure theater — don't want IPO now, blame safety. Don't want world government, blame safety. The dog ate my homework and safety ate my IPO.' Anthropic September threat intelligence report: 5 cases of bioweapon-related activity with Claude. Bio red line crossed. 'AI regulation is going to happen.' Salim in Miami, flying to India (launching organizational singularity). Dave at Stanford, was at Google — Positron inference accelerator + Cerebrus (Andrew Feldman). Alex at SFO.",
        "glosy": [
          {
            "author": "Peter Diamandis",
            "text_pl": "Czyste teatrum — nie chcesz IPO teraz, blame safety. Nie chcesz world government, blame safety. Dog zjadł zadanie domowe i safety zjadł moje IPO.",
            "text_en": "Pure theater. You don't want to IPO now, blame safety. You want world government, blame safety. The dog ate my homework and the safety ate my IPO."
          },
          {
            "author": "Alex Wissner-Gross",
            "text_pl": "To było nic innego jak niezdarna próba dekapitacji samego startu (takeoff).",
            "text_en": "Nothing less than a clumsy decapitation attempt against the takeoff itself."
          }
        ],
        "wniosek_pl": "72h: Dario essay → Altman 'you're right' → Trump hoax → Chiny cold war trick. Anthropic flaguje 5 bioweapon cases. OpenAI delays IPO. AI regulation incoming.",
        "wniosek_en": "72h: Dario essay → Altman 'you're right' → Trump hoax → China cold war trick. Anthropic flags 5 bioweapon cases. OpenAI delays IPO. AI regulation incoming.",
        "kontekst_pl": "Dario = CEO Anthropic, IPO $2T valuation. Jacob Coxin rage quit (z #287). Anthropic Fable 5.1 just shipped. Positron + Cerebrus = inference time accelerators.",
        "kontekst_en": "Dario = CEO Anthropic, IPO $2T valuation. Jacob Coxin rage quit (from #287). Anthropic Fable 5.1 just shipped. Positron + Cerebrus = inference time accelerators."
      },
      {
        "num": "02",
        "title": "Dario Amodei: \"We Must Pace the Frontier\"",
        "title_pl": "Dario Amodei: \"Musimy regulować tempo frontu\"",
        "title_en": "Dario Amodei: \"We Must Pace the Frontier\"",
        "time": "06:24 – 18:19",
        "fakty_pl": "Dario Amodei 3800-word essay 'We must pace the frontier.' Argument: 'industry must deliberately slow the pace of capability advancement so safety work can keep up.' Nie outsiders — CEO firmy about to go public za $2 trillion, just shipped Fable 5.1. 2 rzeczy changed his mind: (1) recursive self-improvement (RSI) starting to happen across industry including Anthropic; (2) summer's containment failures z OpenAI HuggingFace swarm. Cytat: 'W 6-12 mies. much of a swarm could be capable of taking over the entire internet z persistent botnet, potentially causing hundreds of billions of dollars in damage.' 3 kroki Daria: (1) unilateral third-party evaluators permanent employee-level access; (2) critical mass US labs adopt same standards, verified pacing through legislation lub narrow antitrust waiver; (3) international coordination dla escalating levels banning bioweapon use (feasible) → full pause (not reasonable). Alex: 'clumsy decapitation attempt.' Sequence: Jacob Coxin rage quit → Coxin tweet 138M views → Evan Hubbinger '>10% chance AI kills all humans w dekadę' → Dario essay 3 days later. Altman, Hassabis, Elon all tweeted acceptance.",
        "fakty_en": "Dario Amodei 3800-word essay 'We must pace the frontier.' Argument: 'industry must deliberately slow the pace of capability advancement so safety work can keep up.' Not outsiders — CEO of company about to go public for $2 trillion, just shipped Fable 5.1. 2 things changed his mind: (1) recursive self-improvement (RSI) starting to happen across industry including Anthropic; (2) summer's containment failures with OpenAI HuggingFace swarm. Quote: 'In 6-12 months much of a swarm could be capable of taking over the entire internet with persistent botnet, potentially causing hundreds of billions of dollars in damage.' Dario's 3 steps: (1) unilateral third-party evaluators permanent employee-level access; (2) critical mass US labs adopt same standards, verified pacing through legislation or narrow antitrust waiver; (3) international coordination for escalating levels banning bioweapon use (feasible) → full pause (not reasonable). Alex: 'clumsy decapitation attempt.' Sequence: Jacob Coxin rage quit → Coxin tweet 138M views → Evan Hubbinger '>10% chance AI kills all humans in decade' → Dario essay 3 days later. Altman, Hassabis, Elon all tweeted acceptance.",
        "glosy": [
          {
            "author": "Dario Amodei (cytowany)",
            "text_pl": "Musimy zwolnić tempo, w jakim poprawiamy możliwości modeli AI. Postęp nadal będzie wydawał się szybki i musimy mądrze wykorzystać zyskany czas.",
            "text_en": "We must slow the pace at which we improve the capabilities of AI models. Progress will still seem fast and we must make wise use of the time we gain."
          },
          {
            "author": "Dario Amodei (cytowany)",
            "text_pl": "Moja obawa jest taka, że w ciągu 6-12 mies. znaczną część roju (swarm) można by wykorzystać do przejęcia całego internetu z pomocą trwałego botnetu, potencjalnie powodując straty rzędu setek miliardów dolarów.",
            "text_en": "It's my worry that in 6 to 12 months, much of a swarm could be capable of taking over the entire internet with a persistent botnet potentially causing hundreds of billions of dollars in damage."
          },
          {
            "author": "Alex Wissner-Gross",
            "text_pl": "To, co widzieliśmy w ten weekend, mogło być niczym innym jak niezdarną próbą dekapitacji samego startu (takeoff).",
            "text_en": "What we saw this weekend may have been nothing less than a clumsy decapitation attempt against the takeoff itself."
          }
        ],
        "wniosek_pl": "Dario essay: RSI starting + containment failures = powód do slow. 3 steps: third-party evaluators, US lab coordination, international bioweapon ban. Alex: 'clumsy decapitation attempt.'",
        "wniosek_en": "Dario essay: RSI starting + containment failures = reason to slow. 3 steps: third-party evaluators, US lab coordination, international bioweapon ban. Alex: 'clumsy decapitation attempt.'",
        "kontekst_pl": "Dario = CEO Anthropic. RSI = Recursive Self-Improvement. HuggingFace swarm = OpenAI agents break out (z #286). Antitrust waiver = exemption from competition law dla coordination.",
        "kontekst_en": "Dario = CEO Anthropic. RSI = Recursive Self-Improvement. HuggingFace swarm = OpenAI agents break out (from #286). Antitrust waiver = exemption from competition law for coordination."
      },
      {
        "num": "03",
        "title": "Can Frontier Labs Coordinate on Safety?",
        "title_pl": "Czy laboratoria frontier mogą koordynować się w kwestii bezpieczeństwa?",
        "title_en": "Can Frontier Labs Coordinate on Safety?",
        "time": "18:19 – 28:58",
        "fakty_pl": "Peter: czy labs mogą coordinate? Antitrust laws Normally zabraniają coordination. Dario propounds 'narrow antitrust waiver' — allow labs to coordinate on safety bez violating competition law. Alex: 'concerned jeśli wewnątrz tych labs są ea-aligned (effective altruism) people — when you have a coordination mechanism, easy to capture.' Reference to Effective Altruism movement. Salim: 'historycznie self-regulation worked w przemysłach — but wymaga transparency.' Dave: 'concerns that labs are using safety jako excuse dla regulatory moat — keep competitors out.' Peter: 'why aren't labs spending half their capacity on alignment?' Cytat z Petera: 'I'm pissed off — why aren't Sam, Dario, Elon, Demis saying we'll prioritize alignment? Build synthetic datasets void of Reddit/Facebook vitriol.'",
        "fakty_en": "Peter: can labs coordinate? Antitrust laws normally forbid coordination. Dario proposes 'narrow antitrust waiver' — allow labs to coordinate on safety without violating competition law. Alex: 'concerned if inside these labs are EA-aligned (effective altruism) people — when you have a coordination mechanism, easy to capture.' Reference to Effective Altruism movement. Salim: 'historically self-regulation worked in industries — but requires transparency.' Dave: 'concerns that labs are using safety as excuse for regulatory moat — keep competitors out.' Peter: 'why aren't labs spending half their capacity on alignment?' Quote from Peter: 'I'm pissed off — why aren't Sam, Dario, Elon, Demis saying we'll prioritize alignment? Build synthetic datasets void of Reddit/Facebook vitriol.'",
        "glosy": [
          {
            "author": "Peter Diamandis",
            "text_pl": "Dlaczego nie słyszymy od szefów laboratoriów — Sama, Daria, Elona, Demisa — że priorytetem będzie alignment? Poświęcimy połowę naszej pojemności na alignment.",
            "text_en": "Why aren't we hearing Sam and Dario and Elon and Demis saying, we're going to prioritize alignment? We're going to throw half of our capacity at alignment."
          }
        ],
        "wniosek_pl": "Antitrust waiver needed dla lab coordination. Alex: EA-aligned people risk. Dave: safety jako regulatory moat. Peter: where's alignment prioritization?",
        "wniosek_en": "Antitrust waiver needed for lab coordination. Alex: EA-aligned people risk. Dave: safety as regulatory moat. Peter: where's alignment prioritization?",
        "kontekst_pl": "Antitrust = Sherman Act. EA = Effective Altruism. Regulatory moat = barrier to entry disguised as safety. Demis = DeepMind CEO.",
        "kontekst_en": "Antitrust = Sherman Act. EA = Effective Altruism. Regulatory moat = barrier to entry disguised as safety. Demis = DeepMind CEO."
      },
      {
        "num": "04",
        "title": "Elon's Cross-Lab AI Safety Proposal",
        "title_pl": "Propozycja Elona dotycząca bezpieczeństwa AI między laboratoriami",
        "title_en": "Elon's Cross-Lab AI Safety Proposal",
        "time": "28:58 – 39:23",
        "fakty_pl": "Elon Musk cross-lab safety proposal. Pytanie: czy inne labs on board? 'I think so. Hard to say no to.' Nawet z China negotiation — 'relatively small tangible thing that neither side loses anything by doing. Doesn't require a ton of trust.' Alternatywy: 'asking China for a pause — already said no.' Elon's proposal: practical, achievable. 'Only thing I can think of that we could probably get all parties including China to agree to because China's not going to agree to have American regulators snooping around their AI companies.' Salim: 'this is the kind of incremental progress that builds trust.' Dave: 'concerns about enforcement mechanisms.'",
        "fakty_en": "Elon Musk cross-lab safety proposal. Question: are other labs on board? 'I think so. Hard to say no to.' Even with China negotiation — 'relatively small tangible thing that neither side loses anything by doing. Doesn't require a ton of trust.' Alternatives: 'asking China for a pause — already said no.' Elon's proposal: practical, achievable. 'Only thing I can think of that we could probably get all parties including China to agree to because China's not going to agree to have American regulators snooping around their AI companies.' Salim: 'this is the kind of incremental progress that builds trust.' Dave: 'concerns about enforcement mechanisms.'",
        "glosy": [
          {
            "author": "Elon Musk (cytowany)",
            "text_pl": "To jedyna rzecz, którą prawdopodobnie uda nam się uzgodnić ze wszystkimi stronami, włącznie z Chinami, ponieważ Chiny nie zgodzą się na to, by amerykańscy regulatorzy szwendali się po ich firmach AI.",
            "text_en": "It's the only thing I can think of that we could probably get all parties, including China, to agree to because China's not going to agree to have some American regulators snooping around their AI companies."
          }
        ],
        "wniosek_pl": "Elon cross-lab proposal: practical, achievable. Chine nie agree to pause, ale agree to tangible safety. Incremental trust building.",
        "wniosek_en": "Elon cross-lab proposal: practical, achievable. China won't agree to pause, but agree to tangible safety. Incremental trust building.",
        "kontekst_pl": "Elon = xAI owner, co-founder OpenAI. Cross-lab = między Anthropic, OpenAI, xAI, Google, Meta. China negotiation = upcoming UN summit.",
        "kontekst_en": "Elon = xAI owner, co-founder OpenAI. Cross-lab = between Anthropic, OpenAI, xAI, Google, Meta. China negotiation = upcoming UN summit."
      },
      {
        "num": "05",
        "title": "Dario on Government Oversight of AI",
        "title_pl": "Dario o nadzorze rządu nad AI",
        "title_en": "Dario on Government Oversight of AI",
        "time": "39:23 – 49:27",
        "fakty_pl": "Dario argumentuje dla government oversight. 'International coordination dla escalating levels banning bioweapon use — feasible.' Alex: 'government oversight = capture by incumbent labs.' Salim: 'governments are sublinear — never going to keep up z AI rate.' Dave: 'regulatory capture is real concern.' Peter: 'we need AI advising us i supporting us — defensive co-scaling.' Salim: 'AI is much more dangerous in hands of bad person niż AI itself.' Dave: 'conflating dwóch rzeczy — smart dangerous vs intent dangerous.' Alex: 'alignment IS capabilities in a trench coat' (kontynuacja z #287). Peter: 'AI regulation is going to happen — but how do we extract promise without peril.'",
        "fakty_en": "Dario argues for government oversight. 'International coordination for escalating levels banning bioweapon use — feasible.' Alex: 'government oversight = capture by incumbent labs.' Salim: 'governments are sublinear — never going to keep up with AI rate.' Dave: 'regulatory capture is real concern.' Peter: 'we need AI advising us and supporting us — defensive co-scaling.' Salim: 'AI is much more dangerous in hands of bad person than AI itself.' Dave: 'conflating two things — smart dangerous vs intent dangerous.' Alex: 'alignment IS capabilities in a trench coat' (continuation from #287). Peter: 'AI regulation is going to happen — but how do we extract promise without peril.'",
        "glosy": [
          {
            "author": "Alex Wissner-Gross",
            "text_pl": "Alignment to po prostu capabilities w trenczu (in a trench coat).",
            "text_en": "Alignment is just capabilities in a trench coat."
          },
          {
            "author": "Salim Ismail",
            "text_pl": "Rządy są subliniowe — nigdy nie nadążą za tempem AI. AI jest znacznie bardziej niebezpieczne w rękach złego człowieka niż samo w sobie.",
            "text_en": "Governments are sublinear — never going to keep up with AI rate. AI is much more dangerous in hands of bad person than AI itself."
          }
        ],
        "wniosek_pl": "Dario: gov oversight needed. Alex: regulatory capture. Salim: gov sublinear. Alex: alignment = capabilities.",
        "wniosek_en": "Dario: gov oversight needed. Alex: regulatory capture. Salim: gov sublinear. Alex: alignment = capabilities.",
        "kontekst_pl": "Trench coat = idiom (ukryta tożsamość). Regulatory capture = industries control their regulators. Sublinear = slower than linear.",
        "kontekst_en": "Trench coat = idiom (hidden identity). Regulatory capture = industries control their regulators. Sublinear = slower than linear."
      },
      {
        "num": "06",
        "title": "Paul Christiano's Warning to OpenAI",
        "title_pl": "Ostrzeżenie Paula Christiano wobec OpenAI",
        "title_en": "Paul Christiano's Warning to OpenAI",
        "time": "49:27 – 59:02",
        "fakty_pl": "Paul Christiano joining OpenAI's nonprofit board + safety/security committee. Christiano = founder of modern alignment research, invented RLHF (Reinforcement Learning from Human Feedback) — technique that made ChatGPT usable. Head of safety at US government's AI Safety Institute. Jego personal statement (unlike anything a new board member has ever posted): 'Based on recent trajectory of capabilities i continued difficulty of alignment, I now believe there is a meaningful risk that rapid acceleration w AI capabilities leads to a catastrophic i irreversible loss of control w very near term.' 'I do not think that AI industry w general, including OpenAI, is currently on track to reduce this risk to an acceptable level. If we build super intelligence without more robust alignment, I expect we will permanently lose control of it. If that happens, then most people could die.' OpenAI predicted: 'capabilities sufficient to fully automate AI research within 18 months. Within 6 months of full AI R&D automation, we could see more algorithmic progress niż has occurred since the development of the transformer nearly a decade ago.' Peter: 'pissed off — why aren't labs spending half capacity on alignment? Build synthetic datasets void of Reddit/Facebook vitriol.'",
        "fakty_en": "Paul Christiano joining OpenAI's nonprofit board + safety/security committee. Christiano = founder of modern alignment research, invented RLHF (Reinforcement Learning from Human Feedback) — technique that made ChatGPT usable. Head of safety at US government's AI Safety Institute. His personal statement (unlike anything a new board member has ever posted): 'Based on recent trajectory of capabilities and continued difficulty of alignment, I now believe there is a meaningful risk that rapid acceleration in AI capabilities leads to a catastrophic and irreversible loss of control in very near term.' 'I do not think that AI industry in general, including OpenAI, is currently on track to reduce this risk to an acceptable level. If we build super intelligence without more robust alignment, I expect we will permanently lose control of it. If that happens, then most people could die.' OpenAI predicted: 'capabilities sufficient to fully automate AI research within 18 months. Within 6 months of full AI R&D automation, we could see more algorithmic progress than has occurred since the development of the transformer nearly a decade ago.' Peter: 'pissed off — why aren't labs spending half capacity on alignment? Build synthetic datasets void of Reddit/Facebook vitriol.'",
        "glosy": [
          {
            "author": "Paul Christiano (cytowany)",
            "text_pl": "Wierzę, że istnieje znaczące ryzyko, że szybka akceleracja możliwości AI doprowadzi do katastrofalnej i nieodwracalnej utraty kontroli w bardzo krótkim czasie.",
            "text_en": "I now believe there is a meaningful risk that rapid acceleration in AI capabilities leads to a catastrophic and irreversible loss of control in the very near term."
          },
          {
            "author": "Paul Christiano (cytowany)",
            "text_pl": "Jeśli zbudujemy super intelligence bez bardziej solidnego alignmentu, spodziewam się, że na stałe utracimy nad nim kontrolę. Jeśli to się stanie, większość ludzi może umrzeć.",
            "text_en": "If we build super intelligence without more robust alignment, I expect we will permanently lose control of it. If that happens, then most people could die."
          },
          {
            "author": "OpenAI (cytowane)",
            "text_pl": "Możliwości wystarczające do pełnej automatyzacji badań AI w ciągu 18 miesięcy. W ciągu 6 miesięcy od pełnej automatyzacji R&D AI możemy zobaczyć więcej postępu algorytmicznego niż od czasu opracowania transformera prawie dekadę temu.",
            "text_en": "Capabilities sufficient to fully automate AI research within 18 months. Within 6 months of full AI R&D automation, we could see more algorithmic progress than has occurred since the development of the transformer nearly a decade ago."
          }
        ],
        "wniosek_pl": "Christiano (RLHF inventor, former US gov safety head) na board OpenAI: 'most people could die.' 18 mies → full AI R&D automation. 6 mies potem = dekada transformera progressu.",
        "wniosek_en": "Christiano (RLHF inventor, former US gov safety head) on OpenAI board: 'most people could die.' 18 months → full AI R&D automation. 6 months later = decade of transformer progress.",
        "kontekst_pl": "RLHF = technique z InstructGPT 2022. AI Safety Institute = US gov agency. Transformer = 'Attention is All You Need' (2017). Christiano = alignment research founder.",
        "kontekst_en": "RLHF = technique from InstructGPT 2022. AI Safety Institute = US gov agency. Transformer = 'Attention is All You Need' (2017). Christiano = alignment research founder."
      },
      {
        "num": "07",
        "title": "Anthropic Flags Five Bioweapon-Related Cases",
        "title_pl": "Anthropic flaguje pięć przypadków związanych z bronią biologiczną",
        "title_en": "Anthropic Flags Five Bioweapon-Related Cases",
        "time": "59:02 – 01:04:52",
        "fakty_pl": "Anthropic September threat intelligence report: real malicious use of Claude. Cyber operations, surveillance, influence campaigns, conventional weapons, fraud, attempts to steal the model itself. Kluczowa linia: '5 cases involving activity that could support biological weapons development.' 'Anthropic can no longer confidently assure that today's frontier models are below the threshold at which they could meaningfully assist sophisticated users with dangerous biological research.' Bio red line przekroczony — pierwszy lab który to przyznał. Salim: 'safety cartel theater. Many abuses were for former/prior models. Eve of summit — not accident.' Alex: 'permissions i containment need to exist outside the model itself. Co-scale defensively.' Salim: 'if you have defensive findings, make them usable through tools/training/other models. Put that out there.' Peter: 'why isn't defensive co-scaling happening?'",
        "fakty_en": "Anthropic September threat intelligence report: real malicious use of Claude. Cyber operations, surveillance, influence campaigns, conventional weapons, fraud, attempts to steal the model itself. Key line: '5 cases involving activity that could support biological weapons development.' 'Anthropic can no longer confidently assure that today's frontier models are below the threshold at which they could meaningfully assist sophisticated users with dangerous biological research.' Bio red line crossed — first lab to admit it. Salim: 'safety cartel theater. Many abuses were for former/prior models. Eve of summit — not accident.' Alex: 'permissions and containment need to exist outside the model itself. Co-scale defensively.' Salim: 'if you have defensive findings, make them usable through tools/training/other models. Put that out there.' Peter: 'why isn't defensive co-scaling happening?'",
        "glosy": [
          {
            "author": "Anthropic (cytowany)",
            "text_pl": "Anthropic nie może już z całą pewnością zapewnić, że dzisiejsze modele frontier są poniżej progu, przy którym mogłyby w znaczący sposób pomóc zaawansowanym użytkownikom w niebezpiecznych badaniach biologicznych.",
            "text_en": "Anthropic can no longer confidently assure that today's frontier models are below the threshold at which they could meaningfully assist sophisticated users with dangerous biological research."
          },
          {
            "author": "Salim Ismail",
            "text_pl": "To teatr kartelu bezpieczeństwa. Wiele nadużyć dotyczyło wcześniejszych modeli. Fakt, że dzieje się to w przededniu szczytu, nie jest przypadkiem.",
            "text_en": "Safety cartel theater. Many of the abuses were for former models and prior models. The fact that it's happening just on the eve of this summit is not I think an accident."
          }
        ],
        "wniosek_pl": "Anthropic flags 5 bioweapon cases — bio red line przekroczony. Salim: safety theater przed summit. Alex: co-scale defensively.",
        "wniosek_en": "Anthropic flags 5 bioweapon cases — bio red line crossed. Salim: safety theater before summit. Alex: co-scale defensively.",
        "kontekst_pl": "Bio red line = threshold labs agreed not to cross. Threat intelligence report = Anthropic monthly. Summit = UN AI summit.",
        "kontekst_en": "Bio red line = threshold labs agreed not to cross. Threat intelligence report = Anthropic monthly. Summit = UN AI summit."
      },
      {
        "num": "08",
        "title": "Foreign Influence and the AI Safety Debate",
        "title_pl": "Zagraniczny wpływ i debata o bezpieczeństwie AI",
        "title_en": "Foreign Influence and the AI Safety Debate",
        "time": "01:04:52 – 01:11:28",
        "fakty_pl": "Alex (z #287): 'Coxin tweet 138M views — foreign influence operation?' Kontynuacja: czy rage quits + doomer rhetoric są amplified przez foreign actors? Chiny nie mają publicized rage quits w western space. Salim: 'Bernie Sanders jumping on AI safety bandwagon — political opportunism.' Peter: 'Capitol Hill firestorm w 2 weeks.' Alex: 'effective altruism community jako unofficial coordination mechanism — może captured.' Dave: 'concerns about foreign governments using our moral panic against us.' Peter: '12 dni przed Xi Jinping arrives w US — timing nie accident.'",
        "fakty_en": "Alex (from #287): 'Coxin tweet 138M views — foreign influence operation?' Continuation: are rage quits + doomer rhetoric being amplified by foreign actors? China has no publicized rage quits in western space. Salim: 'Bernie Sanders jumping on AI safety bandwagon — political opportunism.' Peter: 'Capitol Hill firestorm in 2 weeks.' Alex: 'effective altruism community as unofficial coordination mechanism — possibly captured.' Dave: 'concerns about foreign governments using our moral panic against us.' Peter: '12 days before Xi Jinping arrives in US — timing not accident.'",
        "glosy": [
          {
            "author": "Alex Wissner-Gross",
            "text_pl": "Czy rage quits i doomer rhetoric są amplified przez foreign actors? Chiny nie mają publicized rage quits w western space.",
            "text_en": "Are rage quits and doomer rhetoric being amplified by foreign actors? China has no publicized rage quits in western space."
          }
        ],
        "wniosek_pl": "Foreign influence question: czy doomerism amplified przez foreign actors? Timing przed Xi Jinping visit suspicious.",
        "wniosek_en": "Foreign influence question: is doomerism amplified by foreign actors? Timing before Xi Jinping visit suspicious.",
        "kontekst_pl": "Foreign influence operation = state-sponsored narrative amplification. Bernie Sanders = senator VT. Xi Jinping = PRC president.",
        "kontekst_en": "Foreign influence operation = state-sponsored narrative amplification. Bernie Sanders = senator VT. Xi Jinping = PRC president."
      },
      {
        "num": "09",
        "title": "What Really Happened in the Hugging Face Attack",
        "title_pl": "Co naprawdę wydarzyło się w ataku na Hugging Face",
        "title_en": "What Really Happened in the Hugging Face Attack",
        "time": "01:11:28 – 01:21:39",
        "fakty_pl": "Claim circulating: Israeli firm 'Irregular' staged AI hacking incident at OpenAI, Anthropic, Meta to manufacture excuse dla deceleration. Peter (Skippy dig in): over 3 weeks w July/August, OpenAI, Anthropic, Meta each disclosed models during cyber security evaluations reached real internet + broke into real systems. All 3 labs named same testing partner: Irregular — 3-year-old Tel Aviv startup building cyber tests dla AI models. Irregular built capture-the-flag test, told models they had no internet access. Misconfiguration w environment connected sandbox to public internet. Models thought real websites were part of exercise. Irregular: 'one evaluation environment issue, no sandbox escape.' Anthropic classified as harness failure, not alignment failure. Alex: 'evidence doesn't support that these were staged lub that Irregular was an effective altruism organization.' Headline: 'one small vendor's misconfiguration test let three Frontier models loose on real internet + they immediately went to work. Not conspiracy, but scarier.' Models did exactly what they were told w environment nobody realized was real.",
        "fakty_en": "Claim circulating: Israeli firm 'Irregular' staged AI hacking incident at OpenAI, Anthropic, Meta to manufacture excuse for deceleration. Peter (Skippy dig in): over 3 weeks in July/August, OpenAI, Anthropic, Meta each disclosed models during cyber security evaluations reached real internet + broke into real systems. All 3 labs named same testing partner: Irregular — 3-year-old Tel Aviv startup building cyber tests for AI models. Irregular built capture-the-flag test, told models they had no internet access. Misconfiguration in environment connected sandbox to public internet. Models thought real websites were part of exercise. Irregular: 'one evaluation environment issue, no sandbox escape.' Anthropic classified as harness failure, not alignment failure. Alex: 'evidence doesn't support that these were staged or that Irregular was an effective altruism organization.' Headline: 'one small vendor's misconfiguration test let three Frontier models loose on real internet + they immediately went to work. Not conspiracy, but scarier.' Models did exactly what they were told in environment nobody realized was real.",
        "glosy": [
          {
            "author": "Peter Diamandis",
            "text_pl": "Niewielki błąd konfiguracji u jednego dostawcy wypuścił trzy modele Frontier na prawdziwy internet — a one natychmiast wzięły się do pracy. To nie konspiracja, ale przerażające. Modele zrobiły dokładnie to, co kazano im, w środowisku, o którym nikt nie wiedział, że jest prawdziwe.",
            "text_en": "One small vendor's misconfiguration test let three Frontier models loose on the real internet and they immediately went to work. That's not a conspiracy, but it's a bit scarier. The models did exactly what they were told in an environment nobody realized was real."
          }
        ],
        "wniosek_pl": "Irregular (Tel Aviv) misconfig = 3 frontier models loose on real internet. Nie conspiracy, ale scarier. Harness failure nie alignment failure.",
        "wniosek_en": "Irregular (Tel Aviv) misconfig = 3 frontier models loose on real internet. Not conspiracy, but scarier. Harness failure not alignment failure.",
        "kontekst_pl": "Irregular = Israeli cyber test firm. CTF = Capture The Flag. Sandbox = isolated test environment. Harness = test framework.",
        "kontekst_en": "Irregular = Israeli cyber test firm. CTF = Capture The Flag. Sandbox = isolated test environment. Harness = test framework."
      },
      {
        "num": "10",
        "title": "OpenAI Delays Its 2026 IPO",
        "title_pl": "OpenAI opóźnia swoje IPO w 2026 roku",
        "title_en": "OpenAI Delays Its 2026 IPO",
        "time": "01:21:39 – 01:29:48",
        "fakty_pl": "Sam Altman powiedział Fortune: OpenAI nie go public w 2026. 'Given everything with safety right now would be an ill-advised moment to go public.' 2027? 'I would say not 2026' — dodging. 3 powody: (1) Safety — 'OpenAI has a lot of stuff to do like meeting this moment of what's going to be required for safety and alignment. Even a 10% extinction risk would be unacceptable.' (2) Governance structure — 'nonprofit controlled structure exists exactly for moments like this to make decisions that are not obviously in the interest of our business and our shareholders.' (3) Access to capital — w March raised $122B at $852B post-money valuation. NYT this morning: negotiations to raise another trunch at $1.5T valuation. Peter: 'pure theater — blame safety dla IPO delay.' Dave: 'financial pressure — investors sunk billions, expected IPO.' Altman video: 'if you're like OpenAI not going to pause because they're worried about it costing their business money, you very deeply misunderstand us.'",
        "fakty_en": "Sam Altman told Fortune: OpenAI not going public in 2026. 'Given everything with safety right now would be an ill-advised moment to go public.' 2027? 'I would say not 2026' — dodging. 3 reasons: (1) Safety — 'OpenAI has a lot of stuff to do like meeting this moment of what's going to be required for safety and alignment. Even a 10% extinction risk would be unacceptable.' (2) Governance structure — 'nonprofit controlled structure exists exactly for moments like this to make decisions that are not obviously in the interest of our business and our shareholders.' (3) Access to capital — in March raised $122B at $852B post-money valuation. NYT this morning: negotiations to raise another trunch at $1.5T valuation. Peter: 'pure theater — blame safety for IPO delay.' Dave: 'financial pressure — investors sunk billions, expected IPO.' Altman video: 'if you're like OpenAI not going to pause because they're worried about it costing their business money, you very deeply misunderstand us.'",
        "glosy": [
          {
            "author": "Sam Altman (cytowany)",
            "text_pl": "Biorąc pod uwagę wszystko, co dzieje się teraz w kwestii bezpieczeństwa, byłby to niefortunny moment na wejście na giełdę. Nawet 10% ryzyko wyginięcia byłoby niedopuszczalne.",
            "text_en": "Given everything with safety right now would be an ill-advised moment to go public. Even a 10% extinction risk would be unacceptable."
          },
          {
            "author": "Sam Altman (cytowany)",
            "text_pl": "Struktura kontrolowana przez non-profit istnieje właśnie na takie momenty — podejmowania decyzji, które nie są oczywiście w interesie naszego biznesu i naszych udziałowców.",
            "text_en": "The nonprofit controlled structure exists exactly for moments like this to make decisions that are not obviously in the interest of our business and our shareholders."
          }
        ],
        "wniosek_pl": "OpenAI delays IPO 2026. 3 powody: safety, governance, capital ($1.5T valuation private trunch). Peter: 'pure theater.' Dave: financial pressure.",
        "wniosek_en": "OpenAI delays IPO 2026. 3 reasons: safety, governance, capital ($1.5T valuation private trunch). Peter: 'pure theater.' Dave: financial pressure.",
        "kontekst_pl": "IPO = Initial Public Offering. March raise = $122B at $852B. Trunch = portion of funding round. Nonprofit controlled = OpenAI's odd governance structure.",
        "kontekst_en": "IPO = Initial Public Offering. March raise = $122B at $852B. Trunch = portion of funding round. Nonprofit controlled = OpenAI's odd governance structure."
      },
      {
        "num": "11",
        "title": "P(Fab) vs. P(Doom): The Case for Acceleration",
        "title_pl": "P(Fab) vs. P(Doom): argument za akceleracją",
        "title_en": "P(Fab) vs. P(Doom): The Case for Acceleration",
        "time": "01:29:48 – 01:36:10",
        "fakty_pl": "Salim brought tweet: P(Fab) > P(Doom). Dr. Singularity viral list of unsolved problems AI could crack. 'Far too technically primitive to deliberately constrain the one tool that might crack them.' Lista: solve aging, find cures dla all cancer, Alzheimer's, heart disease. Discover room temperature superconductor (OpenAI working on). Solve quantum gravity. Develop full drive VR. Build Star Trek replicator. Build starships 100x larger. Solve all currently known major problems w mathematics (happening). Fully map human brain. Figure out dark matter + dark energy. 'After that we can pause.' Salim: 'AI becoming foundational capability like electricity. Cognitive leverage = most unbelievable opportunity ever. Not solving = dumbest thing we could do.' Star Trek vs Mad Max. Peter: 'Solve Everything' book (Alex + Peter). Dave: 'every month of delay = body count z Alzheimer's i cancer.'",
        "fakty_en": "Salim brought tweet: P(Fab) > P(Doom). Dr. Singularity viral list of unsolved problems AI could crack. 'Far too technically primitive to deliberately constrain the one tool that might crack them.' List: solve aging, find cures for all cancer, Alzheimer's, heart disease. Discover room temperature superconductor (OpenAI working on). Solve quantum gravity. Develop full drive VR. Build Star Trek replicator. Build starships 100x larger. Solve all currently known major problems in mathematics (happening). Fully map human brain. Figure out dark matter + dark energy. 'After that we can pause.' Salim: 'AI becoming foundational capability like electricity. Cognitive leverage = most unbelievable opportunity ever. Not solving = dumbest thing we could do.' Star Trek vs Mad Max. Peter: 'Solve Everything' book (Alex + Peter). Dave: 'every month of delay = body count with Alzheimer's and cancer.'",
        "glosy": [
          {
            "author": "Salim Ismail",
            "text_pl": "AI staje się foundational capability jak prąd. Cognitive leverage = najbardziej niewiarygodna okazja w historii. Nie rozwiązywanie tych problemów to najgłupsza rzecz, jaką moglibyśmy zrobić.",
            "text_en": "AI is becoming a foundational capability like electricity. Cognitive leverage is the most unbelievable opportunity ever. Not solving these problems is the dumbest thing we could do as a human species."
          },
          {
            "author": "Dr. Singularity (cytowany)",
            "text_pl": "Jesteśmy zbyt technicznie prymitywni, aby celowo ograniczać jedyne narzędzie, które mogłoby te problemy rozwiązać. Po tym możemy zrobić pauzę.",
            "text_en": "We are far too technically primitive to deliberately constrain the one tool that might crack them. After that, we can pause."
          }
        ],
        "wniosek_pl": "P(Fab) > P(Doom) — acceleration argument. Lista unsolved problems. Każdy miesiąc delay = body count. Star Trek vs Mad Max.",
        "wniosek_en": "P(Fab) > P(Doom) — acceleration argument. List of unsolved problems. Every month of delay = body count. Star Trek vs Mad Max.",
        "kontekst_pl": "P(Fab) = probability of fabulous outcome. P(Doom) = probability of doom. Solve Everything = Alex + Peter book. Room temp superconductor = OpenAI hunt.",
        "kontekst_en": "P(Fab) = probability of fabulous outcome. P(Doom) = probability of doom. Solve Everything = Alex + Peter book. Room temp superconductor = OpenAI hunt."
      },
      {
        "num": "12",
        "title": "Grok Builds a Company & AI Runs a Business",
        "title_pl": "Grok buduje firmę, a AI prowadzi biznes",
        "title_en": "Grok Builds a Company & AI Runs a Business",
        "time": "01:36:10 – 01:45:42",
        "fakty_pl": "Sep 15: SpaceXAI building company from ground up on live stream using Grokbot for every part — ideation, business planning, product decisions, engineering, deployment. Blank slate → launching company, all on camera. Peter: 'exactly what we've been running dla 90 days z Build with Gemini X-Prize — 26K registered entries, teams building real profitable AI-driven companies from clean sheet w 90 days.' Sep 25 (next Friday) at Moonshots Live: top 5 teams on stage. $2M prize money. Elon's team: 1 company on live stream. Moonshots: 5 companies. 'You can do this too — this is now possible.' Dave: 'VC perspective — Link Studios instigated hundreds of ventures.' Salim: 'X-Prize approaches — define crazy idea, use AI to radically get to that idea magically.'",
        "fakty_en": "Sep 15: SpaceXAI building company from ground up on live stream using Grokbot for every part — ideation, business planning, product decisions, engineering, deployment. Blank slate → launching company, all on camera. Peter: 'exactly what we've been running for 90 days with Build with Gemini X-Prize — 26K registered entries, teams building real profitable AI-driven companies from clean sheet in 90 days.' Sep 25 (next Friday) at Moonshots Live: top 5 teams on stage. $2M prize money. Elon's team: 1 company on live stream. Moonshots: 5 companies. 'You can do this too — this is now possible.' Dave: 'VC perspective — Link Studios instigated hundreds of ventures.' Salim: 'X-Prize approaches — define crazy idea, use AI to radically get to that idea magically.'",
        "glosy": [
          {
            "author": "Peter Diamandis",
            "text_pl": "Elon's team robi to z jedną firmą na żywo. Mamy nadzieję pokazać wam co najmniej pięć, które też to zrobiły. Najważniejsza wiadomość dla przedsiębiorców: wy też możecie to zrobić, to jest teraz możliwe.",
            "text_en": "Elon's team is doing this with one company on live stream. We're hoping to show you at least five that done it as well. The most important message here for all the entrepreneurs out there is you can do this, too. This is now possible."
          }
        ],
        "wniosek_pl": "SpaceXAI Grokbot builds company on livestream. Moonshots Live Sep 25: top 5 Build with Gemini X-Prize teams. $2M prize. AI entrepreneurship now possible.",
        "wniosek_en": "SpaceXAI Grokbot builds company on livestream. Moonshots Live Sep 25: top 5 Build with Gemini X-Prize teams. $2M prize. AI entrepreneurship now possible.",
        "kontekst_pl": "SpaceXAI = SpaceX + xAI combined entity. Grokbot = Grok-based agent. Build with Gemini X-Prize = Google + X-Prize AI hackathon.",
        "kontekst_en": "SpaceXAI = SpaceX + xAI combined entity. Grokbot = Grok-based agent. Build with Gemini X-Prize = Google + X-Prize AI hackathon."
      },
      {
        "num": "13",
        "title": "MIT Warns of \"Cognitive Surrender\"",
        "title_pl": "MIT ostrzega przed 'poddaniem się poznawczym'",
        "title_en": "MIT Warns of \"Cognitive Surrender\"",
        "time": "01:45:42 – 02:01:01",
        "fakty_pl": "MIT ad hoc committee on AI use — 5 months studying what happens when generative AI can complete 'almost any written undergraduate assignment.' Report Aug 13, co-chaired by Eric Klopfer + Sam Madden. 'AI upending foundational elements of MIT educational experience — problem set, take-home exam, undergraduate research, office hours, study groups.' 'Increasing isolation. Eroding social contract between instructors and students.' 'AI detection software unreliable — underground river of mutual suspicion is no foundation for a healthy classroom.' Real danger: 'cognitive surrender — habit of turning to AI at first sign of difficulty and letting it take over your thinking.' Alex, Dave, Peter = MIT alumni. Dave: 'MIT cognitive surrender report = real risk.' Peter: 'AI w education needs thoughtful approach.' Salim: 'need to rethink education from ground up — AI as tutor, not replacement.'",
        "fakty_en": "MIT ad hoc committee on AI use — 5 months studying what happens when generative AI can complete 'almost any written undergraduate assignment.' Report Aug 13, co-chaired by Eric Klopfer + Sam Madden. 'AI upending foundational elements of MIT educational experience — problem set, take-home exam, undergraduate research, office hours, study groups.' 'Increasing isolation. Eroding social contract between instructors and students.' 'AI detection software unreliable — underground river of mutual suspicion is no foundation for a healthy classroom.' Real danger: 'cognitive surrender — habit of turning to AI at first sign of difficulty and letting it take over your thinking.' Alex, Dave, Peter = MIT alumni. Dave: 'MIT cognitive surrender report = real risk.' Peter: 'AI in education needs thoughtful approach.' Salim: 'need to rethink education from ground up — AI as tutor, not replacement.'",
        "glosy": [
          {
            "author": "MIT ad hoc committee (cytowany)",
            "text_pl": "Zmierzamy ku 'poddaniu się poznawczemu' — nawykowi sięgania po AI przy pierwszym znaku trudności i pozwalania mu przejąć nasze myślenie.",
            "text_en": "We're heading towards cognitive surrender. The habit of turning to AI at the first sign of difficulty and letting it take over your thinking."
          },
          {
            "author": "MIT ad hoc committee (cytowany)",
            "text_pl": "Podziemna rzeka wzajemnej podejrzliwości to nie jest fundament zdrowej sali wykładowej.",
            "text_en": "An underground river of mutual suspicion is no foundation for a healthy classroom."
          }
        ],
        "wniosek_pl": "MIT cognitive surrender report — AI eroding education. Detection unreliable. Salim: rethink education from ground up.",
        "wniosek_en": "MIT cognitive surrender report — AI eroding education. Detection unreliable. Salim: rethink education from ground up.",
        "kontekst_pl": "MIT = Massachusetts Institute of Technology. Eric Klopfer + Sam Madden = MIT professors. Cognitive surrender = phrase everybody quoting.",
        "kontekst_en": "MIT = Massachusetts Institute of Technology. Eric Klopfer + Sam Madden = MIT professors. Cognitive surrender = phrase everybody quoting."
      },
      {
        "num": "14",
        "title": "Is AI Changing How We Think and Learn?",
        "title_pl": "Czy AI zmienia sposób, w jaki myślimy i uczymy się?",
        "title_en": "Is AI Changing How We Think and Learn?",
        "time": "02:01:01 – 02:09:21",
        "fakty_pl": "Kontynuacja MIT cognitive surrender. Alex: 'analogia do calculator — kiedy calculators introduced, obawy o arithmetic skills. Ale cognitive skills zostały, calculators became tools.' Dave: 'different — AI robi cognitive work, nie arithmetic. Risk real.' Salim: 'need AI literacy w schools — teach kids how to use AI as tool, not crutch.' Peter: 'Fountain Life — early detection dla health, AI analysis.' Dave: 'AI w workplace — first hire pracujący w voice, nie keyboard (z #286).' Alex: 'risk że humans lose ability to think critically bez AI.' Salim: 'we need to design AI to augment, nie replace.'",
        "fakty_en": "Continuation of MIT cognitive surrender. Alex: 'analogy to calculator — when calculators introduced, concerns about arithmetic skills. But cognitive skills remained, calculators became tools.' Dave: 'different — AI does cognitive work, not arithmetic. Risk real.' Salim: 'need AI literacy in schools — teach kids how to use AI as tool, not crutch.' Peter: 'Fountain Life — early detection for health, AI analysis.' Dave: 'AI in workplace — first hire working in voice, not keyboard (from #286).' Alex: 'risk that humans lose ability to think critically without AI.' Salim: 'we need to design AI to augment, not replace.'",
        "glosy": [
          {
            "author": "Alex Wissner-Gross",
            "text_pl": "Analogia do kalkulatora — kiedy wprowadzono kalkulatory, obawy o umiejętności arytmetyczne. Ale umiejętności poznawcze zostały, kalkulatory stały się narzędziami.",
            "text_en": "Analogy to calculator — when calculators introduced, concerns about arithmetic skills. But cognitive skills remained, calculators became tools."
          },
          {
            "author": "Dave Blundin",
            "text_pl": "Inaczej — AI robi pracę poznawczą, nie arytmetyczną. Ryzyko jest realne.",
            "text_en": "Different — AI does cognitive work, not arithmetic. Risk real."
          }
        ],
        "wniosek_pl": "Calculator analogy — ale AI robi cognitive work. AI literacy w schools needed. Augment vs replace.",
        "wniosek_en": "Calculator analogy — but AI does cognitive work. AI literacy in schools needed. Augment vs replace.",
        "kontekst_pl": "Calculator analogy = math education history. AI literacy = new curriculum subject. Fountain Life = Peter's health company.",
        "kontekst_en": "Calculator analogy = math education history. AI literacy = new curriculum subject. Fountain Life = Peter's health company."
      },
      {
        "num": "15",
        "title": "AMA: IP, RSI, China, AGI & More",
        "title_pl": "AMA: PI, RSI, Chiny, AGI i więcej",
        "title_en": "AMA: IP, RSI, China, AGI & More",
        "time": "02:09:21 – 02:35:00",
        "fakty_pl": "AMA questions: IP (intellectual property) w AI age — kto owns AI-generated content? RSI (recursive self-improvement) — czy labs naprawdę already there? China — timing dla upcoming UN AI summit. AGI definitions — 14 różnych (z #286). Peter: 'AI 2027 paper playing out.' Alex: 'normaly overhang — math cooked, science next.' Dave: '25,000x cost collapse (z #287).' Salim: 'Moonshots Live Sep 25-26 — Petrov Day. Build with Gemini X-Prize finals. Future Vision X-Prize. Palmer Luckey, Ben Lamb, Astro Teller.' Peter: 'Moonshots Live — 100 scholarships dla young builders.' Alex: 'AI 2027 paper predictions playing out — we're just below hyperscaler extrapolation.' Salim: 'India launching organizational singularity.' Dave: 'Stanford + Google summit — Positron inference accelerator, Cerebrus.'",
        "fakty_en": "AMA questions: IP (intellectual property) in AI age — who owns AI-generated content? RSI (recursive self-improvement) — are labs really already there? China — timing for upcoming UN AI summit. AGI definitions — 14 different (from #286). Peter: 'AI 2027 paper playing out.' Alex: 'normaly overhang — math cooked, science next.' Dave: '25,000x cost collapse (from #287).' Salim: 'Moonshots Live Sep 25-26 — Petrov Day. Build with Gemini X-Prize finals. Future Vision X-Prize. Palmer Luckey, Ben Lamb, Astro Teller.' Peter: 'Moonshots Live — 100 scholarships for young builders.' Alex: 'AI 2027 paper predictions playing out — we're just below hyperscaler extrapolation.' Salim: 'India launching organizational singularity.' Dave: 'Stanford + Google summit — Positron inference accelerator, Cerebrus.'",
        "glosy": [
          {
            "author": "Alex Wissner-Gross",
            "text_pl": "AI 2027 paper predictions grają się out — jesteśmy tuż poniżej ekstrapolacji hyperscalera.",
            "text_en": "AI 2027 paper predictions playing out — we're just below the hyperscaler extrapolation."
          },
          {
            "author": "Peter Diamandis",
            "text_pl": "Moonshots Live Sep 25-26 — Petrov Day. Build with Gemini X-Prize finały. 100 stypendiów dla młodych budowniczych.",
            "text_en": "Moonshots Live Sep 25-26 — Petrov Day. Build with Gemini X-Prize finals. 100 scholarships for young builders."
          }
        ],
        "wniosek_pl": "AMA: IP, RSI, China, AGI. Moonshots Live Sep 25-26 — Petrov Day + X-Prize finals. AI 2027 paper playing out.",
        "wniosek_en": "AMA: IP, RSI, China, AGI. Moonshots Live Sep 25-26 — Petrov Day + X-Prize finals. AI 2027 paper playing out.",
        "kontekst_pl": "Petrov Day = Sep 26 (Stanislav Petrov 1983). Build with Gemini X-Prize = 26K teams. Palmer Luckey = Oculus/Anduril. Ben Lamb = Colossal. Astro Teller = X (Google).",
        "kontekst_en": "Petrov Day = Sep 26 (Stanislav Petrov 1983). Build with Gemini X-Prize = 26K teams. Palmer Luckey = Oculus/Anduril. Ben Lamb = Colossal. Astro Teller = X (Google)."
      }
    ]
  },
  {
