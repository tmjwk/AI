...
const RECENT_EPISODES = [
  {
    ...
    "hosts": [
      ...
      },
      {
        ...
        "dot_color": "var(--hp)",
        "role_pl": "**„Wewnętrzne ASI” (In-house ASI)**. Perspektywa techniczna, głęboka technologia (deep tech), fotonika kwantowa, obliczenia orbitalne.",
      ...
      },
      {
        "name": "Dave Blundin",
        "dot_color": "var(--hp)",
        "role_pl": "**Partner zarządzający Link Exponential Ventures**. Perspektywa biznesowa, rynki, wyceny, venture capital.",
      ...
      },
      {
        "name": "Salim Ismail",
        "dot_color": "var(--hp)",
        "role_pl": "**CEO OpenExo, światowy podróżnik**. Perspektywa wykładnicza, organizacje wykładnicze.",
    ...
    "topics": [
      {
        ...
        "glosy": [
          {
            "host": "Peter",
            "dot_color": "var(--hp)",
            "text_pl": "Eksperci zawsze mówią, jak czegoś NIE DA SIĘ zrobić. **„Strzeżcie się ekspertów”** — to reakcja obronna układu odpornościowego establishmentu.",
          ...
          },
          {
            "host": "Alex",
            "dot_color": "var(--hp)",
            "text_pl": "**„Zawsze powinieneś wyciągnąć logarytm z rzeczywistej historii, zanim przekażesz ją ekspertom do ich liniowej ekstrapolacji.”** Definicja eksperta: ktoś, kto wie, dlaczego coś nie zadziała.",
          ...
          },
          {
            "host": "Dave",
            "dot_color": "var(--hp)",
            "text_pl": "AI jest wyprzedane. **Ekosystem zorientowany na sprzęt** zastępuje ten zorientowany na AI.",
        ...
        "kontekst_pl": "Morgan Stanley przewidywał **14 000 chińskich robotów do 2025 roku** — rzeczywistość daleko przerosła te prognozy. Prawo Moore'a miało skończyć się w 2022 roku, ale tak się nie stało. Alex: „Zawsze powinieneś wyciągnąć logarytm z rzeczywistej historii, zanim przekażesz ją ekspertom do ich liniowej ekstrapolacji.” — eksperci liniowo ekstrapolują to, co jest wykładnicze. Peter: „Strzeżcie się ekspertów” — reakcja obronna układu odpornościowego establishmentu na zmiany. Dave: AI jest wyprzedane, ekosystem zorientowany na sprzęt zastępuje ten zorientowany na AI.",
      ...
      },
      {
        ...
        "time": "25:53 – 33:24",
        "fakty_pl": "Sacramento — dron z magnesem rozbroił napastnika z nożem. Orlando — policja używa dronów jako pierwszych ratowników (first responders). Kłusownicy w Afryce — drony odstraszają kłusowników nad stadami słoni.",
        ...
        "glosy": [
          {
            "host": "Peter",
            "dot_color": "var(--hp)",
            "text_pl": "Drony jako **pierwsi ratownicy (first responders)** — to zmienia paradygmat egzekwowania prawa.",
          ...
          },
          {
            "host": "Alex",
            "dot_color": "var(--hp)",
            "text_pl": "Dron to robot. **Każdy dron to zastosowanie robotyki.**",
        ...
        "kontekst_pl": "**Sacramento**: dron z magnesem rozbroił napastnika z nożem. **Orlando**: policja używa dronów jako pierwszych ratowników — dron dociera na miejsce zdarzenia szybciej niż patrol. W **Afryce** drony patrolują obszary nad stadami słoni i odstraszają kłusowników. Alex: każdy dron to zastosowanie robotyki. Peter: drony zmieniają paradygmat egzekwowania prawa. Dave: prawo zawsze nadąża za technologią z opóźnieniem — regulacje dławią innowacje.",
      ...
      },
      {
        ...
        "time": "37:14 – 49:55",
        "fakty_pl": "Helion (wspierany przez Sama Altmana) uzyskał zatwierdzenia regulacyjne stanu Waszyngton dla elektrowni fuzji jądrowej Orion. Oczekiwana elektrownia o mocy 400 MW około 2032 roku. Fuzja „wreszcie tu jest” — a nie oddalona o 50 lat, jak mówi żart.",
        ...
        "glosy": [
          {
            "host": "Peter",
            "dot_color": "var(--hp)",
            "text_pl": "**„Gdybyś obserwował właściwą metrykę, mógłbyś przewidzieć, kiedy to nastąpi, a to jest bliskie”.**",
          ...
          },
          {
            "host": "Alex",
            "dot_color": "var(--hp)",
            "text_pl": "Europa ma kłopoty — <strong>gwarancje co do energetyki jądrowej słabną</strong>. Podstawowe zapotrzebowanie wymaga fuzji.",
            "text_en": "Europe's in trouble — <strong>nuclear buzz is softening</strong>. Base load needs fusion."
          },
          {
            "host": "Dave",
            "dot_color": "var(--hp)",
            "text_pl": "Energetyka jądrowa staje się <strong>strategiczna dla USA</strong>. Wymagane są ogromne inwestycje.",
            "text_en": "Nuclear becoming <strong>strategic for US</strong>. Massive investments needed."
          }
        ],
        "wniosek_pl": "Fuzja jądrowa przechodzi z fazy **„zawsze o 50 lat stąd”** do **„bliżej niż myślisz”**. Helion jest głównym kandydatem.",
        ...
        "kontekst_pl": "**Helion** (firma wspierana przez Sama Altmana) uzyskała zatwierdzenia regulacyjne stanu Waszyngton dla elektrowni fuzji jądrowej **Orion**. Oczekiwana elektrownia o mocy 400 MW około 2032 roku. Peter: „Gdybyś obserwował właściwą metrykę, mógłbyś przewidzieć, kiedy to nastąpi, a to jest bliskie”. Alex: Europa ma kłopoty — szum wokół energetyki jądrowej słabnie, obciążenie podstawowe (base load) potrzebuje fuzji. Dave: energia jądrowa staje się strategiczna dla USA, potrzebne są masowe inwestycje. Żart o fuzji „zawsze oddalonej o 50 lat” powoli umiera.",
      ...
      },
      {
        ...
        "glosy": [
          ...
          },
          {
            "host": "Alex",
            "dot_color": "var(--hp)",
            "text_pl": "Grok ma <strong>szansę dzięki surowej sile obliczeniowej</strong>. Przychody SpaceX wyprzedzają pozostałe firmy kosmiczne razem wzięte.",
          ...
          },
          {
            "host": "Dave",
            "dot_color": "var(--hp)",
            "text_pl": "Google ma **monopol pionowy**. Elon nie sądzi, że przegra.",
        ...
        "kontekst_pl": "**Grok 4.5** to model bazowy V9 o rozmiarze 1,5T parametrów. Elon twierdzi, że pre-training odbywa się co miesiąc — agresywna iteracja. Wcześniej Grok był „podłączony pod respirator”, teraz to **powrót za pomocą brutalnej siły**. Alex: Grok ma szansę dzięki brutalnej sile obliczeniowej; przychody SpaceX wyprzedzają AWS i GCP pod względem tempa wzrostu (run rate). Dave: Google ma monopol pionowy, ale Elon nie sądzi, że przegra. Strategia Elona: kontrolować infrastrukturę (SpaceX, moce obliczeniowe) + modele budowane brutalną siłą (Grok 4.5) = pionowa integracja całego stosu.",
      ...
      },
      {
        ...
        "time": "63:59 – 74:00",
        "fakty_pl": "Fable 5 niedostępny przez 15 dni (wycofany przez rząd USA). Może powrócić „w ciągu kilku dni”. Sonnet 5 jako „wypełniacz” — przeciętne możliwości, wysoka cena. Ryzyko regulacyjne jest teraz zmienną pierwszego rzędu dla inwestorów.",
        ...
        "glosy": [
          {
            "host": "Peter",
            "dot_color": "var(--hp)",
            "text_pl": "Ten moment będzie <strong>zapamiętany w historii</strong>. Przecięcie sztucznej inteligencji i rządu, które nigdy nie zniknie.",
          ...
          },
          {
            "host": "Alex",
            "dot_color": "var(--hp)",
            "text_pl": "Sonnet 5 to **wypełniacz luki**, dopóki Fable 5 nie wróci. Ludzie musieli go używać, bo nic innego nie było dostępne.",
          ...
          },
          {
            "host": "Dave",
            "dot_color": "var(--hp)",
            "text_pl": "AI jest wyprzedane. <strong>Anthropic podwoił cenę Fable</strong>, ale musieliście go używać.",
            "text_en": "AI is sold out. <strong>Anthropic doubled the price on Fable</strong> but you had to use it."
          }
        ],
        "wniosek_pl": "**Ryzyko regulacyjne** stało się zmienną pierwszego rzędu dla inwestorów AI. Fable 5 to przypadek testowy — czy rząd pozwoli na powrót wiodącego modelu.",
        ...
        "kontekst_pl": "**Fable 5** był wyłączony przez 15 dni po interwencji rządu USA. Może powrócić „w ciągu kilku dni”. **Sonnet 5** służył jako „wypełniacz” — przeciętne możliwości, wysoka cena. Alex: ludzie musieli używać Sonnet 5, ponieważ nic innego nie było dostępne. Dave: AI jest wyprzedane, Anthropic podwoił cenę Fable, ale i tak trzeba było z tego korzystać. Peter: ten moment zostanie zapamiętany w historii — punkt przecięcia AI i rządu, który już nigdy nie zniknie. Ryzyko regulacyjne stało się **zmienną pierwszego rzędu** dla inwestorów AI.",
      ...
      },
      {
        ...
        "time": "75:38 – 93:03",
        "fakty_pl": "Philip Johnson, CEO StarCloud. Pierwsza karta NVIDIA H100 w kosmosie (listopad 2025 na rakiecie Falcon 9). Wytrenowany pierwszy model językowy (LLM) w kosmosie (Gemma). Energia słoneczna w kosmosie → centra danych w kosmosie. Start StarCloud 2 styczeń 2026.",
        ...
        "glosy": [
          {
            "host": "Philip",
            "dot_color": "var(--ba)",
            "text_pl": "Zaczęli od energii słonecznej w kosmosie, przeszli do centrów danych. <strong>„Połowa naszego zespołu pochodzi z branży energetycznej.\"</strong>",
          ...
          },
          {
            "host": "Peter",
            "dot_color": "var(--hp)",
            "text_pl": "<strong>20 historii na sześciu frontach.</strong> Dużo kapitału napływa.",
            "text_en": "<strong>20 stories across six fronts.</strong> Lots of capital flowing."
          },
          {
            "host": "Alex",
            "dot_color": "var(--hp)",
            "text_pl": "<strong>Integracja pionowa</strong> — SpaceX posiada infrastrukturę do startów, satelity, pasmo częstotliwości oraz, w coraz większym stopniu, moc obliczeniową.",
            "text_en": "<strong>Vertical integration</strong> — SpaceX owns launch, satellite, spectrum, increasingly compute."
          },
          {
            "host": "Dave",
            "dot_color": "var(--hp)",
            "text_pl": "Historia przedsiębiorczości Philipa — **iść jedną drogą i dostrzec ogromną szansę**.",
            "text_en": "Philip's entrepreneurial story — <strong>going down one road, seeing a massive opportunity</strong>."
          }
        ],
        "wniosek_pl": "Centra danych w kosmosie to **naturalna ewolucja** — nieograniczona energia słoneczna, brak potrzeby chłodzenia, brak problemu NIMBY (nie na moim podwórku). StarCloud to dowód koncepcji (H100 + Gemma na orbicie).",
        ...
        "kontekst_pl": "**Philip Johnson**, CEO StarCloud, mówi o kosmicznych centrach danych. W listopadzie 2025 roku na pokładzie Falcon 9 **pierwszy procesor graficzny NVIDIA H100 został wyniesiony na orbitę**. Pierwszy LLM został wytrenowany w kosmosie (**Gemma**). Zaczęło się od koncepcji kosmicznej energii słonecznej, po czym nastąpił zwrot w stronę centrów danych. „Połowa naszego zespołu przeszła ze SpaceX, reszta z AWS i Azure.” Start **StarCloud 2** w styczniu 2026 roku. Alex: integracja pionowa — SpaceX kontroluje wynoszenie, satelity, pasmo, a coraz częściej także moce obliczeniowe. Dave: historia przedsiębiorczości Philipa — szedł jedną drogą, po czym dostrzegł ogromną szansę. Peter: 20 historii na sześciu frontach, napływa mnóstwo kapitału. Kosmiczne centra danych = naturalna ewolucja: nieograniczona energia słoneczna, brak chłodzenia, brak NIMBY.",
      ...
      },
      {
        ...
        "time": "93:03 – 110:22",
        "fakty_pl": "Elon ogłasza bezpośrednie połączenia telefoniczne przez Starlink. Telefony trafią do sprzedaży za ~2 lata. Rocket Lab przejmuje Iridium (konstelacja 66 satelitów, orbita na wysokości 780 km). Pierwsza wielokrotnie używalna rakieta Rocket Lab do końca roku.",
        ...
        "glosy": [
          {
            "host": "Peter",
            "dot_color": "var(--hp)",
            "text_pl": "<strong>Ponowna integracja wertykalna</strong> — SpaceX posiada starty, satelity, częstotliwości oraz moc obliczeniową.",
            "text_en": "<strong>Vertical integration again</strong> — SpaceX owns launch, satellite, spectrum, compute."
          },
          {
            "host": "Alex",
            "dot_color": "var(--hp)",
            "text_pl": "**Lasery to przyszłość** komunikacji kosmicznej — nieregulowane pasmo.",
            "text_en": "<strong>Lasers are the future</strong> for space comms — unregulated spectrum."
          },
          {
            "host": "Dave",
            "dot_color": "var(--hp)",
            "text_pl": "Rocket Lab przejmuje Iridium — <strong>pionowa integracja startu + konstelacji</strong>.",
            "text_en": "Rocket Lab acquiring Iridium — <strong>vertical integration of launch + constellation</strong>."
          }
        ],
        "wniosek_pl": "SpaceX i Rocket Lab dokonują **pionowej integracji całych stosów** — od wynoszenia, przez satelity, aż po usługi. Usługa direct-to-phone to kolejny krok w dominacji SpaceX.",
        ...
        "kontekst_pl": "Elon zapowiada **direct-to-phone przez Starlink** — telefony dostępne za około 2 lata. **Rocket Lab przejmuje Iridium** (konstelacja 66 satelitów, orbita 780 km). Pierwszy stopień wielokrotnego użytku Rocket Lab do końca roku. Peter: ponownie integracja pionowa — SpaceX kontroluje wynoszenie, satelity, pasmo, obliczenia. Alex: lasery to przyszłość komunikacji kosmicznej — nieregulowane pasmo. Dave: Rocket Lab przejmujące Iridium — pionowa integracja wynoszenia + konstelacji. SpaceX i Rocket Lab dokonują pionowej integracji całych stosów — od wynoszenia, przez satelity, aż po usługi. Direct-to-phone to kolejny krok w dominacji SpaceX.",
        ...
        "title_pl": "SpaceX połączenie bezpośrednie na telefon + przejęcie Rocket Lab przez Iridium",
        "title_en": "SpaceX direct-to-phone + Rocket Lab acquiring Iridium"
      }
    ],
    "title_pl": "Stan sztucznej inteligencji i robotyki | #268",
  ...
  },
  {
    ...
    "hosts": [
      ...
      },
      {
        "name": "Dr. Alexander Wissner-Gross",
        "dot_color": "var(--hp)",
        "role_pl": "**Informatyk i inwestor**. Perspektywa techniczna, głęboka technologia, fotonika kwantowa, obliczenia orbitalne.",
      ...
      },
      {
        "name": "Dave Blundin",
        "dot_color": "var(--hp)",
        "role_pl": "**Współzałożyciel Link Ventures**. Perspektywa biznesowa, rynki, wyceny, venture capital.",
    ...
    "topics": [
      {
        ...
        "glosy": [
          ...
          },
          {
            "host": "Dave",
            "dot_color": "var(--hp)",
            "text_pl": "To tylko przykrywki i wymówki. To będzie wymówka, której USA i Europa użyją, aby w jakiś sposób stłumić chińską sztuczną inteligencję.",
          ...
          },
          {
            "host": "Alex",
            "dot_color": "var(--hp)",
            "text_pl": "To jest moment Sputnika, ale zaskoczenie przyszło od wewnątrz. Mythos potrafi odpowiedzieć na pytanie „czy możesz pomóc mi zbudować samego siebie?” w 4,8 sekundy. Jesteśmy w końcówce gry — Chiny osiągnęły prędkość ucieczki.",
        ...
        "kontekst_pl": "**Mythos 5** potrafi odpowiedzieć na pytanie „czy możesz pomóc mi zbudować samego siebie?” — Opus 4.8 tego nie potrafi. To jest granica, którą przekraczają Mythos i GPT-5.6: samodoskonalenie. 4,8 sekundy wystarczyło, aby Mythos odpowiedział. **Andrej Karpathy** (Kanadyjczyk) nie może używać Mythos, ponieważ nie jest obywatelem USA. **GLM 5.2** bije GPT-5.5 na SWE-bench Pro — Chińczycy nie muszą już kopiować, mają swój własny model graniczny. Mythos przeszedł ćwiczenia typu red team z Departamentem Obrony USA (Projekt Glass Wing) — włamał się do tajnych systemów w kilka godzin, a nie tygodni. Senator Mark Warner: „To narzędzie włamało się do prawie wszystkich naszych tajnych systemów, nie w tygodnie, ale w kilka godzin”.",
        ...
        "title_pl": "Rząd USA blokuje GPT-5.6 i Mythos",
      ...
      },
      {
        ...
        "time": "42:00 – 53:00",
        "fakty_pl": "Kierownictwo OpenAI wycofuje się z planów szybkiego IPO. Porównanie do IPO SpaceX — Elon „szybko wyszedł” z płynnymi akcjami.",
        "fakty_en": "OpenAI leadership pulls back from near-term IPO. SpaceX IPO comparison — Elon „got out quickly” with liquid stock.",
        "glosy": [
          {
            "host": "Peter",
            "dot_color": "var(--hp)",
            "text_pl": "Bycie spółką publiczną to po prostu inny świat niż bycie firmą prywatną. Nagle zdają sobie sprawę: „wow”.",
          ...
          },
          {
            "host": "Alex",
            "dot_color": "var(--hp)",
            "text_pl": "Elon stracił przewagę w modelach granicznych. Jego sposobem na pozostanie istotnym jest wyjście w kosmos i uruchomienie orbitalnych centrów danych.",
        ...
        "wniosek_pl": "Wejście na giełdę w erze niepewności regulacyjnej = ryzyko. Elon wybrał IPO SpaceX zamiast AI — chce kontrolować **infrastrukturę** (orbitalne centra danych), a not modele.",
        ...
        "kontekst_pl": "SpaceX: szczyt na poziomie 202 USD, spadek do 153 USD. IPO po 135 USD za akcję, otwarcie na poziomie 150 USD — utrzymanie wyceny na poziomie 2 bilionów dolarów. **Daario** (DeepMind), **Sam** (OpenAI), **Elon** — tylko Elon zdecydował się na szybkie wejście na giełdę. OpenAI zebrało 122 miliardy dolarów, ale jest blisko wskaźnika spalania gotówki (burn rate). Anthropic również jest blisko swojego burn rate — będą musieli przeprowadzić kolejną rundę lub IPO. Elon „stracił przewagę w modelach granicznych” — jego strategia to kontrolowanie infrastruktury (kosmiczne centra danych), a nie modeli.",
      ...
      },
      {
        ...
        "glosy": [
          {
            "host": "Peter",
            "dot_color": "var(--hp)",
            "text_pl": "Świat wydaje się zmierzać ścieżką w rodzaju drugiej zimnej wojny.",
            "text_en": "The world seems to be on a path, sort of a second cold war type path."
          },
          {
            "host": "Dave",
            "dot_color": "var(--hp)",
            "text_pl": "To będzie wymówka, której USA, Europa i może Ameryka Południowa użyją, ponieważ muszą w jakiś sposób stłumić chińską AI.",
          ...
          },
          {
            "host": "Alex",
            "dot_color": "var(--hp)",
            "text_pl": "Każdy, kto jest tym zszokowany, zupełnie nie orientuje się w tym, co faktycznie robią Chiny.",
            "text_en": "Anyone who's shocked by this is way out of touch with what China's actually doing."
          }
        ],
        "wniosek_pl": "Destylacja to **wojna asymetryczna** — Chińczycy nie muszą trenować od zera, kopiują ślady rozumowania (reasoning traces) z modeli zachodnich. Przepisy o kontroli eksportu tego nie powstrzymają.",
        ...
        "kontekst_pl": "**Destylacja** oznacza, że model A (Claude) generuje odpowiedzi, a model B (Alibaba) uczy się z tych odpowiedzi. Nie trzeba kraść wag — wystarczy dostęp do API. Właśnie dlatego Anthropic ogranicza API dla chińskich firm. Chińczycy mogą jednak korzystać z pośredników (VPN, spółki krzaki). 12 wzmianek o destylacji w tym odcinku — to główny temat geopolityczny.",
        ...
        "title_pl": "Kampania destylacyjna Alibaba",
      ...
      },
      {
        ...
        "time": "55:23 – 62:00",
        "fakty_pl": "Elon ogłasza pierwsze bezpośrednie <strong>telepatyczne komunikacje między ludźmi</strong> za pośrednictwem Neuralink. Neokortex w chmurze do początku lat 30. XXI wieku.",
        ...
        "glosy": [
          {
            "host": "Peter",
            "dot_color": "var(--hp)",
            "text_pl": "Jedno z największych osiągnięć ludzkości, jeśli zadziała. Kora nowa do chmury do wczesnych lat 30. XXI wieku.",
            "text_en": "One of biggest achievements in humanity if it works. Neocortex to cloud by early 2030s."
          },
          {
            "host": "Alex",
            "dot_color": "var(--hp)",
            "text_pl": "Jeśli hipokamp jest w zasadzie przestrzenią osadzeń transformera typu encoder-only, telepatia będzie o wiele łatwiejsza, niż można by podejrzewać.",
        ...
        "wniosek_pl": "Telepatia może być łatwiejsza niż się wydaje — jeśli mózg używa **przestrzeni osadzeń (embedding space)** podobnej do LLM, komunikacja mózg-mózg to transfer stanów ukrytych (latents), a nie słów.",
        ...
        "kontekst_pl": "Teoria Alexa: **hipokamp** działa jak transformer typu encoder-only. Jeśli to prawda, telepatia = transfer osadzeń między mózgami. „Nie potrzebujesz wszystkich słów. Używasz jak najmniejszej liczby słów, aby aktywować wspólną przestrzeń ukrytą”. Immad przewiduje, że popyt na nieinwazyjne interfejsy mózg-komputer zmusi Neuralink do zmiany kierunku. Elon planuje komunikację kory nowej z chmurą do wczesnych lat 30. XXI wieku.",
      ...
      },
      {
        ...
        "time": "90:35 – 103:00",
        "fakty_pl": "Trump podpisuje dekret o wzmocnieniu amerykańskich komputerów kwantowych. 100 milionów dolarów każdemu dla D-Wave, Rigetti, Inflection. 140 milionów dolarów dla Sai Quantum.",
        ...
        "glosy": [
          ...
          },
          {
            "host": "Alex",
            "dot_color": "var(--hp)",
            "text_pl": "Fotonika kwantowa, a nie komputery kwantowe. Byłbym zszokowany, gdybyśmy do przyszłego grudnia nie rozmawiali o uruchomieniu obliczeń fotonicznych.",
        ...
        "wniosek_pl": "Komputery kwantowe w obecnej formie są **przereklamowane**. Prawdziwym przełomem jest **fotonika kwantowa** — obliczenia fotoniczne przy 1/100 masy dla tych samych operacji. AI odkryje algorytmy kwantowe szybciej niż ludzie.",
        ...
        "title_pl": "Dekret wykonawczy ds. komputerów kwantowych",
      ...
      },
      {
        ...
        "time": "118:00 – 133:00",
        "fakty_pl": "Elon zmienił zdanie (flipped the bit) 9 miesięcy temu — **orbitalne centra danych**. Konstelacja SpaceX jako marka „Sfery Dysona” (Dyson Swarm brand).",
        ...
        "wniosek_pl": "Orbitalne centra danych mogą okazać się **niepotrzebne**, jeśli obliczenia fotoniczne zadziałają — 1/100 masy oznacza, że nie trzeba lecieć w kosmos po moc obliczeniową. Elon potrzebuje jednak narracji dla SpaceX.",
        ...
        "kontekst_pl": "Elon „zmienił zdanie” 9 miesięcy temu — nikt nie mówił o orbitalnych centrach danych, zanim on nie zaczął. Alex: jeśli fotonika pojawi się w horyzoncie 1-2 lat → kosmiczne centra mogą być zbędne. Dave: bezpieczeństwo — „upewnij się, że nikt nie wchodzi za tobą, słuchając tej samej wiązki”. **Star Pipe** = „nowa ropa” SpaceX — orbitalna infrastruktura jako marka Sfery Dysona.",
        ...
        "title_pl": "Centra danych na orbicie",
      ...
      },
      {
        ...
        "time": "125:00 – 138:00",
        "fakty_pl": "Dyskusja o koloniach oceanicznych, habitatach orbitalnych, <strong>przyszłości heterogenicznej vs homogenicznej</strong>.",
        ...
        "glosy": [
          ...
          },
          {
            "host": "Alex",
            "dot_color": "var(--hp)",
            "text_pl": "Gerard K. O'Neill — genialna jednostka, która odeszła od nas zbyt wcześnie.",
        ...
        "kontekst_pl": "Peter: „Zobaczysz ludzi, którzy za 100 lat będą wyglądać zasadniczo tak samo. Jednocześnie zobaczysz post-ludzi.” Heterogeniczność, a nie homogeniczność. Alex nawiązuje do **Gerarda K. O'Neilla** — koncepcji kolonii kosmicznych z lat 70./80. (The High Frontier). Dave: nawet przy masowym bezrobociu wywołanym przez AI, ludzie znajdą sens poprzez przedsiębiorczość. Zakończenie Petera: newsletter o metatrendach na stronie dmandis.com/metatrends.",
        ...
        "title_pl": "Przyszłość ludzkości — kolonizacja kosmosu",
        "title_en": "Future of humanity — space colonization"
      }
    ],
    "title_pl": "Rząd USA blokuje GPT-5.6, kradzież sztucznej inteligencji Alibaba i dlaczego OpenAI opóźnia swoją ofertę publiczną | #267",
