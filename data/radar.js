...
// Schema: episodes = [{id, date, title, collapsed}], SECTIONS = [{id, num, icon, title, type, cards[{desc_pl, desc_en, date, episode_id}]/items[{html_pl, html_en, episode_id}]/headers+rows}]
